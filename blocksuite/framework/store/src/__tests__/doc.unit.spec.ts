...
test('query', () => {
  ...
  const page = store1.addBlock('blank:page');
  const note = store1.addBlock('blank:note', {}, page);
  const paragraph1 = store1.addBlock('blank:paragraph', {}, note);
  const list1 = store1.addBlock('blank:list' as never, {}, note);
  ...
  const list2 = store1.addBlock('blank:list' as never, {}, note);
