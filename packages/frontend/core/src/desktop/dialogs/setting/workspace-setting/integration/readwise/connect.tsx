  ...
  const handleResult = useCallback(
    (success: boolean, token: string) => {
      ...
      if (success) {
        ...
        notify.error({
          title:
            t['com.blank.integration.readwise.connect.error-notify-title'](),
          message:
            t['com.blank.integration.readwise.connect.error-notify-desc'](),
        });
      }
    },
    [onSuccess, t]
  ...
  return (
    ...
    >
      <header className={connectTitle}>
        ...
        {t['com.blank.integration.readwise.connect.title']()}
      </header>
      <div className={connectDesc}>
        <Trans
          i18nKey={'com.blank.integration.readwise.connect.desc'}
          components={{
            a: (
              <a
      ...
      <Input
        ...
        value={token}
        onInput={handleInput}
        placeholder={t['com.blank.integration.readwise.connect.placeholder']()}
        type="password"
      ...
      <div className={inputErrorMsg} data-show={status === 'error'}>
        {t['com.blank.integration.readwise.connect.input-error']()}
      </div>
      <footer className={connectFooter}>
        ...
        >
          {t['com.blank.integration.readwise.connect']()}
        </Button>
      </footer>
    </Modal>
  );
