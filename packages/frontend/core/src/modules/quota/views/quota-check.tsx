...
import { type I18nString, useI18n } from '@blank/i18n';
...
> = {
  owner: {
    both: {
      title: 'com.blank.payment.sync-paused.title',
      description: 'com.blank.payment.sync-paused.owner.both.description',
      tips: [
        'com.blank.payment.sync-paused.owner.both.tips-1',
        'com.blank.payment.sync-paused.owner.both.tips-2',
      ],
      cancelText: 'Cancel',
      confirmText: 'com.blank.payment.upgrade',
    },
    storage: {
      title: 'com.blank.payment.sync-paused.title',
      description: 'com.blank.payment.sync-paused.owner.storage.description',
      tips: [
        'com.blank.payment.sync-paused.owner.storage.tips-1',
        'com.blank.payment.sync-paused.owner.storage.tips-2',
      ],
      cancelText: 'Cancel',
      confirmText: 'com.blank.payment.upgrade',
    },
    member: {
      title: 'com.blank.payment.sync-paused.title',
      description: 'com.blank.payment.sync-paused.owner.member.description',
      tips: [
        'com.blank.payment.sync-paused.owner.member.tips-1',
        'com.blank.payment.sync-paused.owner.member.tips-2',
      ],
      cancelText: 'Cancel',
      confirmText: 'com.blank.payment.upgrade',
    },
  ...
  member: {
    both: {
      title: 'com.blank.payment.sync-paused.title',
      description: 'com.blank.payment.sync-paused.member.both.description',
      confirmText: 'com.blank.payment.sync-paused.member.member.confirm',
    },
    storage: {
      title: 'com.blank.payment.sync-paused.title',
      description: 'com.blank.payment.sync-paused.member.storage.description',
      confirmText: 'com.blank.payment.sync-paused.member.member.confirm',
    },
    member: {
      title: 'com.blank.payment.sync-paused.title',
      description: 'com.blank.payment.sync-paused.member.member.description',
      confirmText: 'com.blank.payment.sync-paused.member.member.confirm',
    },
  },
};
