...
const WorkspaceBlankPropertiesSchemaSchema = z.object({
...
export const WorkspaceBlankPropertiesSchema = z.object({
  schema: WorkspaceBlankPropertiesSchemaSchema.optional(),
...
export type WorkspaceBlankProperties = z.infer<
  typeof WorkspaceBlankPropertiesSchema
>;
...
export type WorkspaceBlankPageProperties = z.infer<
