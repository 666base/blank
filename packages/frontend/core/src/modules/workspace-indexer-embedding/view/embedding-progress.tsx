import { Progress } from '@blank/component';
    ...
    <div className={embeddingProgress} data-testid="embedding-progress-wrapper">
      ...
      >
        <div>
          {loading
            ? t[
                'com.blank.settings.workspace.indexer-embedding.embedding.progress.loading-sync-status'
              ]()
            : synced
              ? t[
                  'com.blank.settings.workspace.indexer-embedding.embedding.progress.synced'
                ]()
              : t[
                  'com.blank.settings.workspace.indexer-embedding.embedding.progress.syncing'
                ]()}
        </div>
        {loading ? null : (
