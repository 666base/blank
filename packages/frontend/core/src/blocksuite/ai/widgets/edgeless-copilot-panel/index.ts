...
import { on, stopPropagation } from '@blocksuite/blank/shared/utils';
...
export class EdgelessCopilotPanel extends WithDisposable(LitElement) {
  static override styles = css`
    ...
    .edgeless-copilot-panel {
      ...
      background: ${unsafeCSSVar('--blank-background-overlay-panel-color')};
      box-shadow: ${unsafeCSSVar('--blank-overlay-shadow')};
      border-radius: 8px;
    ...
    .edgeless-copilot-panel[data-app-theme='light']:hover::-webkit-scrollbar-thumb {
      background-color: ${unsafeCSS(lightCssVariables['--blank-black30'])};
    }

    .edgeless-copilot-panel[data-app-theme='dark']:hover::-webkit-scrollbar-thumb {
      background-color: ${unsafeCSS(darkCssVariables['--blank-black30'])};
    }
  `;
