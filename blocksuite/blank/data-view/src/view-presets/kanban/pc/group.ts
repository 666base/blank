...
const styles = css`
  ...
  blank-data-view-kanban-group:hover .group-header-op {
    visibility: visible;
    opacity: 1;
  }
  ...
  blank-data-view-kanban-group:hover .add-card {
    visibility: visible;
    opacity: 1;
  }

  blank-data-view-kanban-group .add-card:hover {
...
declare global {
  interface HTMLElementTagNameMap {
    'blank-data-view-kanban-group': KanbanGroup;
  }
}
