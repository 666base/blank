import { AIStarIcon } from '@blocksuite/blank/components/icons';
...
import { stopPropagation } from '@blocksuite/blank/shared/utils';
...
export class AIPanelInput extends SignalWatcher(WithDisposable(LitElement)) {
  static override styles = css`
    ...
    :host([data-app-theme='light']) {
      .network svg {
        color: ${unsafeCSS(lightCssVariablesV2['--blank-v2-icon-primary'])};
      }

      .network[data-active='true'] svg {
        color: ${unsafeCSS(lightCssVariablesV2['--blank-v2-icon-activated'])};
      }
      ...
      textarea::placeholder {
        color: ${unsafeCSS(
          lightCssVariablesV2['--blank-v2-text-placeholder']
        )};
      }
      ...
      .arrow {
        background: ${unsafeCSS(
          lightCssVariablesV2['--blank-v2-icon-disable']
        )};
      }

      .arrow[data-active='true'] {
        background: ${unsafeCSS(
          lightCssVariablesV2['--blank-v2-icon-activated']
        )};
      }

      .arrow svg {
        color: ${unsafeCSS(lightCssVariablesV2['--blank-v2-pure-white-text'])};
      }
    }

    :host([data-app-theme='dark']) {
      .network svg {
        color: ${unsafeCSS(darkCssVariablesV2['--blank-v2-icon-primary'])};
      }

      .network[data-active='true'] svg {
        color: ${unsafeCSS(darkCssVariablesV2['--blank-v2-icon-activated'])};
      }
      ...
      textarea::placeholder {
        color: ${unsafeCSS(darkCssVariablesV2['--blank-v2-text-placeholder'])};
      }
      ...
      .arrow {
        background: ${unsafeCSS(
          darkCssVariablesV2['--blank-v2-icon-disable']
        )};
      }

      .arrow[data-active='true'] {
        background: ${unsafeCSS(
          darkCssVariablesV2['--blank-v2-icon-activated']
        )};
      }

      .arrow svg {
        color: ${unsafeCSS(darkCssVariablesV2['--blank-v2-pure-white-text'])};
      }
    }
  `;
    ...
    return html`<div class="root">
      ...
      <div class="textarea-container">
        ...
        >
          ${SendIcon()}
          ${this._hasContent
            ? html`<blank-tooltip .offsetY=${12}>Send to AI</blank-tooltip>`
            : nothing}
        </div>
      </div>
    </div>`;
