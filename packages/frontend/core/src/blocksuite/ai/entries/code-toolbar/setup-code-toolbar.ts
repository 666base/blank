...
import type { BlankCodeToolbarWidget } from '@blocksuite/blank/blocks/code';
import { BlockSelection } from '@blocksuite/blank/std';

import { buildAICodeItemGroups } from '../../_common/config';
import type { AskAIButtonOptions } from '../../components/ask-ai-button';

export function setupCodeToolbarAIEntry(codeToolbar: BlankCodeToolbarWidget) {
