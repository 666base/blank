...
import { ErrorNames, type GetInviteInfoQuery } from '@blank/graphql';
...
export const JoinFailedPage = ({
  ...
  return (
    <AuthPageContainer
      title={t['com.blank.fail-to-join-workspace.title']()}
      subtitle={
        userFriendlyError.name === ErrorNames.MEMBER_QUOTA_EXCEEDED ? (
          <div className={styles.lineHeight}>
            <Trans
              i18nKey={'com.blank.fail-to-join-workspace.description-1'}
              components={{
                1: (
            ...
            />
            <div>{t['com.blank.fail-to-join-workspace.description-2']()}</div>
          </div>
        ) : (
          <div>
