...
describe('DatabaseManager', () => {
  ...
  const selection = [
    { id: '1', value: 'Done', color: 'var(--blank-tag-white)' },
    { id: '2', value: 'TODO', color: 'var(--blank-tag-pink)' },
    { id: '3', value: 'WIP', color: 'var(--blank-tag-blue)' },
  ];

  beforeEach(() => {
    doc = createTestDoc();

    rootId = doc.addBlock('blank:page', {
      title: new Text('database test'),
    });
    noteBlockId = doc.addBlock('blank:note', {}, rootId);
