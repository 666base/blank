    ...
    >
      ...
      >
        {showList.includes('whatNew') && (
          <Tooltip content={t['com.blank.appUpdater.whatsNew']()} side="left">
            <StyledIconWrapper
        ...
        {showList.includes('contact') && (
          <Tooltip content={t['com.blank.helpIsland.contactUs']()} side="left">
            <StyledIconWrapper
        ...
        {showList.includes('shortcuts') && (
          <Tooltip
            content={t['com.blank.keyboardShortcuts.title']()}
            side="left"
          >
            <StyledIconWrapper
      ...
      {spread ? (
        ...
        <Tooltip
          content={t['com.blank.helpIsland.helpAndFeedback']()}
          side="left"
        >
