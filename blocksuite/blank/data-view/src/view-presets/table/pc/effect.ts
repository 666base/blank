...
export function pcEffects() {
  ...
  customElements.define('blank-data-view-table-group', TableGroup);
  customElements.define('dv-table-view-cell-container', TableViewCellContainer);
  customElements.define('blank-database-column-header', DatabaseColumnHeader);
  customElements.define(
    'blank-data-view-column-preview',
    DataViewColumnPreview
  );
  customElements.define('blank-database-header-column', DatabaseHeaderColumn);
  customElements.define(
