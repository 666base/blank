...
import { ColorScheme, type RootBlockModel } from '@blocksuite/blank-model';
import {
  EditPropsStore,
  ThemeProvider,
...
export class EdgelessToolbarWidget extends WidgetComponent<RootBlockModel> {
  static override styles = css`
    ...
    .full-divider::after {
      ...
      width: 1px;
      height: 100%;
      background-color: var(--blank-border-color);
    }
    .pen-and-eraser {
      display: flex;
      height: 100%;
    ...
    return html`
      ...
      <div class="quick-tool-more">
        ...
        >
          ...
          <blank-tooltip tip-position="top" .offset=${25}>
            More Tools
          </blank-tooltip>
        </icon-button>
      </div>
        ...
        >
          ...
          ${cache(
            this._seniorPrevTooltip
              ? html` <blank-tooltip tip-position="top" .offset=${4}>
                  ${this._seniorPrevTooltip}
                </blank-tooltip>`
              : nothing
          )}
      ...
      >
        ...
        >
          <smooth-corner
            ...
            .smooth=${0.7}
            .borderWidth=${1}
            .bgColor=${'var(--blank-background-overlay-panel-color)'}
            .borderColor=${'var(--blank-border-color)'}
