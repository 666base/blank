import { fontSMStyle, fontXSStyle } from '@blocksuite/blank-shared/styles';
import { css } from 'lit';
...
export const COLOR_PICKER_STYLE = css`
  ...
  nav button[active] {
    color: var(--blank-text-primary-color, #121212);
  ...
  .modes .mode button[active] {
    pointer-events: none;
    outline: 2px solid var(--blank-brand-color, #1e96eb);
  }
