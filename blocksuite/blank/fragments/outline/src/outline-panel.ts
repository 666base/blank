...
export const BLANK_OUTLINE_PANEL = 'blank-outline-panel';
...
export class OutlinePanel extends SignalWatcher(
  ...
  override render() {
    ...
    return html`
      <blank-outline-panel-header></blank-outline-panel-header>
      <blank-outline-panel-body> </blank-outline-panel-body>
      <blank-outline-notice></blank-outline-notice>
    `;
  }
...
declare global {
  interface HTMLElementTagNameMap {
    [BLANK_OUTLINE_PANEL]: OutlinePanel;
  }
}
