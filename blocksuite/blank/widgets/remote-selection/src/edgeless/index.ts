...
export const BLANK_EDGELESS_REMOTE_SELECTION_WIDGET =
  'blank-edgeless-remote-selection-widget';
...
export class EdgelessRemoteSelectionWidget extends WidgetComponent<RootBlockModel> {
  ...
  override render() {
    ...
    return html`
      <div class="blank-edgeless-remote-selection">${rects}${cursors}</div>
    `;
  }
...
declare global {
  interface HTMLElementTagNameMap {
    [BLANK_EDGELESS_REMOTE_SELECTION_WIDGET]: EdgelessRemoteSelectionWidget;
  }
}
