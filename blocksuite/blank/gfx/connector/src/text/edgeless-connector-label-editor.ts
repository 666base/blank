...
import { getLineHeight } from '@blocksuite/blank-gfx-text';
import type { ConnectorElementModel } from '@blocksuite/blank-model';
import type { RichText } from '@blocksuite/blank-rich-text';
import { ThemeProvider } from '@blocksuite/blank-shared/services';
import { almostEqual } from '@blocksuite/blank-shared/utils';
...
export class EdgelessConnectorLabelEditor extends WithDisposable(
  ...
  static override styles = css`
    .edgeless-connector-label-editor {
      ...
      border: ${BORDER_WIDTH}px solid var(--blank-primary-color, #1e96eb);
      background: var(--blank-background-primary-color, #fff);
      border-radius: 2px;
