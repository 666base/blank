    ...
    return html` <div class="error-wrapper">
      ...
      <div class="action">
        ...
        >
          ${this.actionText}
          ${this.actionTooltip
            ? html`<blank-tooltip tip-position="top">
                ${this.actionTooltip}
              </blank-tooltip>`
            : nothing}
        </span>
...
const PaymentRequiredErrorRenderer = (host?: EditorHost | null) => html`
  <ai-error-wrapper
    .text=${"You've reached the current usage cap for Blank AI. You can subscribe to Blank AI(with free 7-day-trial) to continue the AI experience!"}
    .actionText=${'Upgrade'}
...
const LoginRequiredErrorRenderer = (host?: EditorHost | null) => html`
  <ai-error-wrapper
    .text=${'You need to login to Blank Cloud to continue using Blank AI.'}
    .actionText=${'Login'}
