...
import type { BlankTextAttributes } from '../../types/index.js';
...
> {
  ...
  private _astChildrenToDelta(
    ...
    const deltas: DeltaInsert<BlankTextAttributes>[] = [];
  ...
  astToDelta(ast: MarkdownAST): DeltaInsert<BlankTextAttributes>[] {
    const context = {
      configs: this.configs,
