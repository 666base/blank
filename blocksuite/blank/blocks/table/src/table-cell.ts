...
import { TextBackgroundDuotoneIcon } from '@blocksuite/blank-components/icons';
import { DefaultInlineManagerExtension } from '@blocksuite/blank-inline-preset';
import type { TableColumn, TableRow } from '@blocksuite/blank-model';
import { RichText } from '@blocksuite/blank-rich-text';
import { cssVarV2 } from '@blocksuite/blank-shared/theme';
...
export const TableCellComponentName = 'blank-table-cell';
export class TableCell extends SignalWatcher(
  ...
  get inlineManager() {
    return this.closest<TableBlockComponent>('blank-table')?.std.get(
      DefaultInlineManagerExtension.identifier
    );
  }

  get topContenteditableElement() {
    return this.closest<TableBlockComponent>('blank-table')
        ...
        <rich-text
          ...
          .verticalScrollContainerGetter="${() =>
            this.topContenteditableElement?.host
              ...
              : null}"
          data-parent-flavour="blank:table"
        ></rich-text>
