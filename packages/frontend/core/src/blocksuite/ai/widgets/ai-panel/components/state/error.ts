...
export class AIPanelError extends WithDisposable(LitElement) {
  static override styles = css`
    ...
    .error {
      ...
      .error-info {
        align-self: stretch;
        color: var(--blank-error-color, #eb4335);
    ...
    .response-list-container ai-item-list {
      --item-padding: 4px;
      --item-icon-color: var(--blank-icon-secondary);
      --item-icon-hover-color: var(--blank-icon-color);
    }
  `;
    ...
    const errorTemplate = choose(
      ...
      [
        [
          ...
          () =>
            html` <div class="error-info">
                You need to login to Blank Cloud to continue using Blank AI.
              </div>
        ...
        [
          ...
          () =>
            html` <div class="error-info">
                You've reached the current usage cap for Blank AI. You can
                subscribe to Blank AI(with free 7-day-trial) to continue the AI
                experience!
              </div>
              <div class="action-button-group">
                <div @click=${this.config.cancel} class="action-button">
      ...
      () => {
        ...
        const error = tip
          ? html`<span class="error-tip">
              An error occurred
              <blank-tooltip tip-position="bottom-start">
                ${tip}
              </blank-tooltip>
            </span>`
          : 'An error occurred';
