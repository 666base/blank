...
export class EmbedIframeLoadingCard extends LitElement {
  static override styles = css`
    ...
    .blank-embed-iframe-loading-card {
      container: blank-embed-iframe-loading-card / size;
      display: flex;
      ...
      @container blank-embed-iframe-loading-card (width < 360px) {
        .loading-banner {
          display: none;
        }
      }
    ...
    .blank-embed-iframe-loading-card.horizontal {
      flex-direction: row;
    ...
    .blank-embed-iframe-loading-card.vertical {
      ...
      @container blank-embed-iframe-loading-card (height < 240px) {
        .loading-banner {
          display: none;
        }
      }
  ...
  override render() {
    ...
    const cardClasses = classMap({
      'blank-embed-iframe-loading-card': true,
