...
const freeBenefits: BenefitsGetter = t => ({
  [t['com.blank.payment.cloud.free.benefit.g1']()]: ([1, 2, 3] as const).map(
    i => ({
      title: t[`com.blank.payment.cloud.free.benefit.g1-${i}`](),
    })
  ),
  [t['com.blank.payment.cloud.free.benefit.g2']()]: (
    [1, 2, 3, 4, 5] as const
  ).map(i => ({
    title: t[`com.blank.payment.cloud.free.benefit.g2-${i}`](),
  })),
});

const proBenefits: BenefitsGetter = t => ({
  [t['com.blank.payment.cloud.pro.benefit.g1']()]: [
    {
      title: t['com.blank.payment.cloud.pro.benefit.g1-1'](),
      icon: <Logo1Icon />,
    },
    ...([2, 3, 4, 5, 7, 8] as const).map(i => ({
      title: t[`com.blank.payment.cloud.pro.benefit.g1-${i}`](),
    })),
  ],
});

const teamBenefits: BenefitsGetter = t => ({
  [t['com.blank.payment.cloud.team-workspace.benefit.g1']()]: [
    {
      title: t['com.blank.payment.cloud.team-workspace.benefit.g1-1'](),
      icon: <Logo1Icon />,
    },
    ...([2, 3, 4, 5, 6] as const).map(i => ({
      title: t[`com.blank.payment.cloud.team-workspace.benefit.g1-${i}`](),
    })),
  ],
});
  ...
  return new Map<SubscriptionPlan, FixedPrice | DynamicPrice>([
    [
      SubscriptionPlan.Free,
      {
        ...
        price: '0',
        yearlyPrice: '0',
        name: t['com.blank.payment.cloud.free.name'](),
        description: t['com.blank.payment.cloud.free.description'](),
        titleRenderer: () => t['com.blank.payment.cloud.free.title'](),
    ...
    [
      SubscriptionPlan.Pro,
      {
        ...
        price: '1',
        yearlyPrice: '1',
        name: t['com.blank.payment.cloud.pro.name'](),
        description: t['com.blank.payment.cloud.pro.description'](),
        titleRenderer: (recurring, detail) => {
          ...
          return (
            <>
              {t['com.blank.payment.cloud.pro.title.price-monthly']({
                price: '$' + price,
              })}
              {recurring === SubscriptionRecurring.Yearly ? (
                <span className={planTitleTitleCaption}>
                  {t['com.blank.payment.cloud.pro.title.billed-yearly']()}
                </span>
              ) : null}
            </>
          );
    ...
    [
      SubscriptionPlan.Team,
      {
        ...
        price: '2',
        yearlyPrice: '2',
        name: t['com.blank.payment.cloud.team-workspace.name'](),
        description: t['com.blank.payment.cloud.team-workspace.description'](),
        titleRenderer: (recurring, detail) => {
          const price =
            recurring === SubscriptionRecurring.Yearly
              ? detail.yearlyPrice
          ...
          return (
            <>
              {t['com.blank.payment.cloud.team-workspace.title.price-monthly'](
                {
                  price: '$' + price,
                }
              )}
              {recurring === SubscriptionRecurring.Yearly ? (
                <span className={planTitleTitleCaption}>
                  {t[
                    'com.blank.payment.cloud.team-workspace.title.billed-yearly'
                  ]()}
                </span>
              ) : null}
            </>
...
const getRecurringLabel = ({
  ...
  return recurring === SubscriptionRecurring.Monthly
    ? t['com.blank.payment.recurring-monthly']()
    : t['com.blank.payment.recurring-yearly']();
};
...
export const CloudPlans = () => {
  ...
  const cloudCaption = loggedIn ? (
    isCanceled ? (
      <p>
        {t['com.blank.payment.subtitle-canceled']({
      ...
      <p>
        <Trans
          plan={currentPlan}
          i18nKey="com.blank.payment.subtitle-active"
          values={{ currentPlan }}
        >
          ...
          <a
            ...
            style={{ color: 'var(--blank-link-color)' }}
          >
            customer support
          </a>
          .
    ...
    <p>{t['com.blank.payment.subtitle-not-signed-in']()}</p>
  );
    ...
    <div className={styles.recurringToggleWrapper}>
      <div>
        <div className={styles.recurringToggleRecurring}>
          <span>
            {t['com.blank.payment.cloud.pricing-plan.toggle-billed-yearly']()}
          </span>
        </div>
        {yearlyDiscount ? (
          <div className={styles.recurringToggleDiscount}>
            {t['com.blank.payment.cloud.pricing-plan.toggle-discount']({
  ...
  const cloudSelect = (
    <div className={styles.cloudSelect}>
      <b>{t['com.blank.payment.cloud.pricing-plan.select.title']()}</b>
      <span>{t['com.blank.payment.cloud.pricing-plan.select.caption']()}</span>
    </div>
  );
