...
export class MultiTagView extends WithDisposable(ShadowlessElement) {
  static override styles = css`
    ...
    .blank-select-cell-container .select-selected {
      height: 22px;
      font-size: 14px;
      line-height: 20px;
      padding: 0 8px;
      border-radius: 4px;
      white-space: nowrap;
      background: var(--blank-tag-white);
      overflow: hidden;
  ...
  override render() {
    ...
    return html`
      <div contenteditable="false" class="blank-select-cell-container">
        ${repeat(values, id => {
  ...
  @query('.blank-select-cell-container')
...
declare global {
  interface HTMLElementTagNameMap {
    'blank-multi-tag-view': MultiTagView;
  }
}
