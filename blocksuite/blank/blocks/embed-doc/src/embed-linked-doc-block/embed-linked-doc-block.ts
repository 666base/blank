...
import { SurfaceBlockModel } from '@blocksuite/blank-block-surface';
import { LoadingIcon } from '@blocksuite/blank-components/icons';
import { isPeekable, Peekable } from '@blocksuite/blank-components/peek';
import { RefNodeSlotsProvider } from '@blocksuite/blank-inline-reference';
import type {
  DocMode,
  EmbedLinkedDocModel,
...
export class EmbedLinkedDocBlockComponent extends EmbedBlockComponent<EmbedLinkedDocModel> {
  ...
  private readonly _renderEmbedView = () => {
    ...
    return this.renderEmbed(
      () => html`
        <div
          class="blank-embed-linked-doc-block ${cardClassMap}"
          @click=${this._handleClick}
          @dblclick=${this._handleDoubleClick}
        >
          <div class="blank-embed-linked-doc-content">
            <div class="blank-embed-linked-doc-content-title">
              <div class="blank-embed-linked-doc-content-title-icon">
                ${icon}
              </div>

              <div class="blank-embed-linked-doc-content-title-text">
                ${title}
              </div>
            </div>
            ...
            ${when(
              hasDescriptionAlias,
              () =>
                html`<div class="blank-embed-linked-doc-content-note alias">
                  ${repeat(
              ...
              () =>
                when(
                  ...
                  () => html`
                    <div class="blank-embed-linked-doc-content-note default">
                      ${defaultNoteContent}
                    </div>
                  `,
                  () => html`
                    <div
                      class="blank-embed-linked-doc-content-note render"
                    ></div>
                  `
                )
            )}
            ${isError
              ? html`
                  <div class="blank-embed-linked-doc-card-content-reload">
                    <div
                      class="blank-embed-linked-doc-card-content-reload-button"
                ...
                `
              : html`
                  <div class="blank-embed-linked-doc-content-date">
                    <span>Updated</span>
          ...
          ${showDefaultBanner
            ? html`
                <div class="blank-embed-linked-doc-banner default">
                  ${defaultBanner}
                </div>
              `
            : nothing}
  ...
  @queryAsync('.blank-embed-linked-doc-content-note.render')
