...
import type { SliderSelectEvent } from '@blocksuite/blank-components/slider';
import {
  DefaultTheme,
  NoteBlockModel,
  type NoteProps,
  ...
  private _renderStylePanel() {
    return html`<div class="edgeless-note-style-panel">
      ...
      <div
        ...
        data-testid="blank-note-border-style-panel"
      >
      ...
      <div
        class="edgeless-note-style-section"
        data-testid="blank-note-corner-radius-panel"
      >
