import { ListBlockSchema } from '@blocksuite/blank-model';
import {
  AdapterTextUtils,
...
export const listBlockHtmlAdapterMatcher: BlockHtmlAdapterMatcher = {
  ...
  fromBlockSnapshot: {
    enter: (o, context) => {
      ...
      if (
        walkerContext.getNodeContext('blank:list:parent') === o.parent &&
        ...
        walkerContext.setNodeContext('blank:list:parent', o.parent);
      }
      ...
      walkerContext.openNode(
        {
          ...
          tagName: 'li',
          properties: {
            className: ['blank-list-block-container'],
          },
          children: liChildren,
        },
        'children'
    ...
    leave: (o, context) => {
      ...
      if (
        walkerContext.getPreviousNodeContext('blank:list:parent') ===
          o.parent &&
