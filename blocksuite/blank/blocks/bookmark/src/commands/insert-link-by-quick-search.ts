import { insertEmbedIframeWithUrlCommand } from '@blocksuite/blank-block-embed';
import {
  type InsertedLinkType,
  insertEmbedLinkedDocCommand,
  insertEmbedSyncedDocCommand,
  type LinkableFlavour,
} from '@blocksuite/blank-block-embed-doc';
import {
  DocModeProvider,
  ...
  const insertedLinkType: Promise<InsertedLinkType> = quickSearchService
    ...
    .then(result => {
      ...
      if ('docId' in result) {
        ...
        let flavour: LinkableFlavour = 'blank:embed-linked-doc';
