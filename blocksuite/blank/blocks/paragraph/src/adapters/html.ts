import { ParagraphBlockSchema } from '@blocksuite/blank-model';
import {
...
const MULTI_PARAGRAPH_EMITTED_NODES_CONTEXT_KEY =
  'blank:paragraph:multi-emitted-nodes';
            ...
            .openNode(
              {
                ...
                tagName: 'div',
                properties: {
                  className: ['blank-paragraph-block-container'],
                },
                children: [],
              },
              'children'
            ...
            .openNode(
              {
                ...
                tagName: 'div',
                properties: {
                  className: ['blank-block-children-container'],
