...
import { ServerSelector } from '@blank/core/components/server-selector';
import {
  AuthService,
  type Server,
  ServersService,
    ...
    <div className={styles.root}>
      ...
      <div className={styles.textContainer}>
        <div className={styles.title}>
          {t['com.blank.enableBlankCloudModal.custom-server.title']({
            workspaceName: workspace?.name$.value || 'untitled',
          })}
        </div>
        <div className={styles.description}>
          {t['com.blank.enableBlankCloudModal.custom-server.description']()}
        </div>
      </div>
      ...
      <Button
        ...
        variant="primary"
      >
        {t['com.blank.enableBlankCloudModal.custom-server.enable']()}
      </Button>
    </div>
  );
};
