import type { Rect } from '@blocksuite/blank-gfx-turbo-renderer';
import {
...
export class ListLayoutHandlerExtension extends BlockLayoutHandlerExtension<ListLayout> {
  ...
  override queryLayout(
    ...
    const listItemSelector =
      '.blank-list-block-container .blank-list-rich-text-wrapper [data-v-text="true"]';
    ...
    listItemNodes.forEach(listItemNode => {
      ...
      if (listItemWrapper.classList.contains('blank-list--checked')) {
        checked = true;
      }
