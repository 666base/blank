...
const styles = css`
  ...
  blank-database-virtual-column-stats:hover .stats-cell {
    opacity: 1;
  }

  .stats-cell:hover,
  blank-database-virtual-column-stats-cell.active .stats-cell {
    opacity: 1;
...
declare global {
  interface HTMLElementTagNameMap {
    'blank-database-virtual-column-stats-cell': VirtualDatabaseColumnStatsCell;
  }
}
