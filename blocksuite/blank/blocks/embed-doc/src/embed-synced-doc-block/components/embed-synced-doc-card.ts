import { RENDER_CARD_THROTTLE_MS } from '@blocksuite/blank-block-embed';
...
export class EmbedSyncedDocCard extends WithDisposable(ShadowlessElement) {
  ...
  override render() {
    ...
    return html`
      <div
        class="blank-embed-synced-doc-card ${cardClassMap}"
        @click=${this._handleClick}
      >
        <div class="blank-embed-synced-doc-card-content">
          <div class="blank-embed-synced-doc-card-content-title">
            <div class="blank-embed-synced-doc-card-content-title-icon">
              ${icon}
            </div>

            <div class="blank-embed-synced-doc-card-content-title-text">
              ${title}
            </div>
          </div>

          ${showDefaultNoteContent
            ? html`<div class="blank-embed-synced-doc-content-note default">
                ${defaultNoteContent}
              </div>`
            : nothing}
          <div class="blank-embed-synced-doc-content-note render"></div>

          ${error
            ? html`
                <div class="blank-embed-synced-doc-card-content-reload">
                  <div
                    class="blank-embed-synced-doc-card-content-reload-button"
              ...
              `
            : html`
                <div class="blank-embed-synced-doc-card-content-date">
                  <span>Updated</span>
        ...
        <div class="blank-embed-synced-doc-card-banner render"></div>

        ${showDefaultBanner
          ? html`
              <div class="blank-embed-synced-doc-card-banner default">
                ${defaultBanner}
              </div>
            `
          : nothing}
  ...
  @queryAsync('.blank-embed-synced-doc-card-banner.render')
  ...
  @queryAsync('.blank-embed-synced-doc-content-note.render')
