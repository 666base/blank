...
import type { DividerBlockModel } from '@blocksuite/blank-model';
import { BLOCK_CHILDREN_CONTAINER_PADDING_LEFT } from '@blocksuite/blank-shared/consts';
...
export class DividerBlockComponent extends CaptionedBlockComponent<DividerBlockModel> {
  ...
  override renderBlock() {
    ...
    return html`
      <div class="blank-divider-block-container">
        <hr />
...
declare global {
  interface HTMLElementTagNameMap {
    'blank-divider': DividerBlockComponent;
  }
}
