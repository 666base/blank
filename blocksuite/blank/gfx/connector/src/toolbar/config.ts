...
import {
  packColor,
  type PickColorEvent,
} from '@blocksuite/blank-components/color-picker';
import type { LineDetailType } from '@blocksuite/blank-components/edgeless-line-styles-panel';
import {
  createTextActions,
  normalizeTextBound,
...
import type { MenuItem } from '@blocksuite/blank-widget-edgeless-toolbar';
import {
  getRootBlock,
  LINE_STYLE_LIST,
  renderMenu,
} from '@blocksuite/blank-widget-edgeless-toolbar';
...
export const connectorToolbarExtension = ToolbarModuleExtension({
  id: BlockFlavourIdentifier('blank:surface:connector'),
