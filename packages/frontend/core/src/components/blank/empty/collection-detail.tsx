...
export const EmptyCollectionDetail = ({
  ...
  return (
    <EmptyLayout
      ...
      title={t['com.blank.empty.collection-detail.title']()}
      description={t['com.blank.empty.collection-detail.description']()}
      action={
  ...
  return (
    <div className={actionGroup}>
      <ActionButton prefix={<AllDocsIcon />} onClick={openAddDocs}>
        {t['com.blank.empty.collection-detail.action.add-doc']()}
      </ActionButton>

      <ActionButton prefix={<FilterIcon />} onClick={openAddRules}>
        {t['com.blank.empty.collection-detail.action.add-rule']()}
      </ActionButton>
    </div>
  );
};
