...
const styles = css`
  .blank-database-toolbar-item.more-action {
    padding: 2px;
    border-radius: 4px;
    display: flex;
    align-items: center;
  ...
  .blank-database-toolbar-item.more-action:hover {
...
export class DataViewHeaderToolsViewOptions extends WidgetBase {
  ...
  override render() {
    ...
    return html` <div
      class="blank-database-toolbar-item more-action"
...
export const popViewOptions = (
  ...
  const isDesktopMenu = () =>
    menuHandler.menu.menuElement.tagName.toLowerCase() === 'blank-menu';
    ...
    get postfix() {
      ...
      return () =>
        html`<div
          ...
          style="padding:4px 8px;font-size:12px;line-height:20px;font-weight:500;border-radius:4px;cursor:pointer;color:var(--blank-primary-color);"
        ...
        items: [
          menuObj => {
              ...
              view.manager.viewMetas.map<MenuConfig>(meta => {
                return menuObj => {
                  ...
                  const textStyle = styleMap({
                    ...
                    color: isSelected
                      ? 'var(--blank-text-emphasis-color)'
                      : 'var(--blank-text-secondary-color)',
                  });
            ...
            return html`
              ...
              >
                <div
                  style="display:flex;align-items:center;color:var(--blank-icon-color);"
                >
                  ${LayoutIcon()}
                </div>
                <div
                  style="font-size:14px;line-height:22px;color:var(--blank-text-secondary-color);"
                >
                  Layout
                </div>
              </div>
