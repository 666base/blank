...
export const BLANK_BLOCK_DIFF_PLAYGROUND = 'blank-block-diff-playground';
export const BLANK_BLOCK_DIFF_PLAYGROUND_MODAL =
  'blank-block-diff-playground-modal';
...
export const blockDiffPlayground = WidgetViewExtension(
  ...
  literal`${unsafeStatic(BLANK_BLOCK_DIFF_PLAYGROUND)}`
);
