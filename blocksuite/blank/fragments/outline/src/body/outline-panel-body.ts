import { changeNoteDisplayMode } from '@blocksuite/blank-block-note';
import { NoteBlockModel, NoteDisplayMode } from '@blocksuite/blank-model';
import { DocModeProvider } from '@blocksuite/blank-shared/services';
import { focusTitle, matchModels } from '@blocksuite/blank-shared/utils';
...
export const BLANK_OUTLINE_PANEL_BODY = 'blank-outline-panel-body';
...
declare global {
  interface HTMLElementTagNameMap {
    [BLANK_OUTLINE_PANEL_BODY]: OutlinePanelBody;
  }
}
