  ...
  override renderBlock() {
    ...
    return this.renderEmbed(
      () => html`
        <div
          class=${classMap({
            'blank-embed-youtube-block': true,
            loading,
        ...
        >
          <div class="blank-embed-youtube-video">
            ${videoId
              ? html`
                  <div class="blank-embed-youtube-video-iframe-container">
                    <iframe
                      id="ytplayer"
                      type="text/html"
                    ...
                    <div
                      class=${classMap({
                        'blank-embed-youtube-video-iframe-overlay': true,
          ...
          <div class="blank-embed-youtube-content">
            <div class="blank-embed-youtube-content-header">
              <div class="blank-embed-youtube-content-title-icon">
                ${titleIcon}
              </div>

              <div class="blank-embed-youtube-content-title-text">
                ${titleText}
              </div>

              <div class="blank-embed-youtube-content-creator-image">
                ${creatorImageEl}
              </div>

              <div class="blank-embed-youtube-content-creator-text">
                ${creator}
              </div>
            </div>
            ...
            ${loading
              ? html`<div
                  class="blank-embed-youtube-content-description"
                ></div>`
              : descriptionText
                ? html`<div class="blank-embed-youtube-content-description">
                    ${descriptionText}
                  </div>`
                : nothing}

            <div class="blank-embed-youtube-content-url" @click=${this.open}>
              <span>www.youtube.com</span>

              <div class="blank-embed-youtube-content-url-icon">
                ${OpenIcon}
              </div>
            </div>
          </div>
