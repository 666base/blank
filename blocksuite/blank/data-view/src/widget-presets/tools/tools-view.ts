...
const styles = css`
  ...
  .toolbar-hover-container:hover .blank-database-toolbar {
    visibility: visible;
    opacity: 1;
  }
  .toolbar-hover-container:has(.active) .blank-database-toolbar {
    visibility: visible;
    opacity: 1;
  }
