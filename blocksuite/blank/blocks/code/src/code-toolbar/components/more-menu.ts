import type { MenuItemGroup } from '@blocksuite/blank-components/toolbar';
import { renderGroups } from '@blocksuite/blank-components/toolbar';
...
export class BlankCodeMoreMenu extends SignalWatcher(
