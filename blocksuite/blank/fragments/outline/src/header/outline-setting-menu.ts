...
export const BLANK_OUTLINE_NOTE_PREVIEW_SETTING_MENU =
  'blank-outline-note-preview-setting-menu';
...
declare global {
  interface HTMLElementTagNameMap {
    [BLANK_OUTLINE_NOTE_PREVIEW_SETTING_MENU]: OutlineNotePreviewSettingMenu;
  }
}
