...
import { rangeWrap } from '@blocksuite/blank-shared/utils';
...
const TABLE_CELL_HOST_SELECTOR =
  'dv-table-view-cell-container, blank-database-virtual-cell-container';
...
declare global {
  interface HTMLElementTagNameMap {
    'blank-multi-tag-select': MultiTagSelect;
  }
}
