import { emailRegex } from '@blank/component/auth-components';
import type {
  InviteLink,
...
export const InviteTeamMemberModal = ({
  ...
  return (
    <ConfirmModal
      ...
      title={t['com.blank.payment.member.team.invite.title']()}
      cancelText={t['com.blank.inviteModal.button.cancel']()}
      cancelButtonOptions={{
        variant: 'secondary',
      }}
      contentOptions={{
      ...
      confirmText={
        inviteMethod === 'email'
          ? t['com.blank.payment.member.team.invite.send-invites']()
          : t['com.blank.payment.member.team.invite.done']()
      }
