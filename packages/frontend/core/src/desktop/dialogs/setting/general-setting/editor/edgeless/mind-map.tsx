...
import { LayoutType, MindmapStyle } from '@blocksuite/blank/model';
...
export const MindMapSettings = () => {
    ...
    () => [
      {
        ...
        label:
          t[
            'com.blank.settings.editorSettings.edgeless.mind-map.layout.left'
          ](),
      },
      {
        ...
        label:
          t[
            'com.blank.settings.editorSettings.edgeless.mind-map.layout.radial'
          ](),
      },
      {
        ...
        label:
          t[
            'com.blank.settings.editorSettings.edgeless.mind-map.layout.right'
          ](),
      },
    ],
    [t]
  ...
  return (
    <>
      <EdgelessSnapshot
        title={t['com.blank.settings.editorSettings.edgeless.mind-map']()}
        docName="mindmap"
      ...
      <SettingRow
        name={t[
          'com.blank.settings.editorSettings.edgeless.mind-map.layout'
        ]()}
        desc={''}
      >
        <RadioGroup
