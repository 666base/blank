...
import type { EmbedIframeBlockModel } from '@blocksuite/blank-model';
import {
  DocModeProvider,
  TelemetryProvider,
...
export class EmbedIframeErrorCard extends WithDisposable(LitElement) {
  static override styles = css`
    ...
    .blank-embed-iframe-error-card {
      container: blank-embed-iframe-error-card / size;
      display: flex;
    ...
    .blank-embed-iframe-error-card.horizontal {
      flex-direction: row;
      ...
      @container blank-embed-iframe-error-card (width < 480px) {
        .error-banner {
          display: none;
        }
      }
    ...
    .blank-embed-iframe-error-card.vertical {
      ...
      @container blank-embed-iframe-error-card (height < 300px) or (width < 300px) {
        .error-banner {
          display: none;
        }
      }
  ...
  override render() {
    ...
    const cardClasses = classMap({
      'blank-embed-iframe-error-card': true,
