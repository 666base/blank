import { type FrameOverlay } from '@blocksuite/blank-block-frame';
import {
...
import type { SelectedRect } from '@blocksuite/blank-shared/types';
import {
  getSelectedRect,
...
export class EdgelessSelectedRectWidget extends WidgetComponent<RootBlockModel> {
  ...
  static override styles = css`
    ...
    .blank-edgeless-selected-rect[data-locked='true'] {
      border-color: ${unsafeCSSVarV2('edgeless/lock/locked', '#00000085')};
    }

    .blank-edgeless-selected-rect .handle {
      position: absolute;
      user-select: none;
      outline: none;
      pointer-events: auto;
    ...
    .blank-edgeless-selected-rect .handle[aria-label^='top-'],
    .blank-edgeless-selected-rect .handle[aria-label^='bottom-'] {
      width: 18px;
      height: 18px;
      box-sizing: border-box;
      z-index: 10;
    ...
    .blank-edgeless-selected-rect .handle[aria-label^='top-'] .resize,
    .blank-edgeless-selected-rect .handle[aria-label^='bottom-'] .resize {
      position: absolute;
      width: 12px;
      height: 12px;
      box-sizing: border-box;
      border-radius: 50%;
      border: 2px var(--blank-blue) solid;
      background: white;
    }

    .blank-edgeless-selected-rect .handle[aria-label^='top-'] .rotate,
    .blank-edgeless-selected-rect .handle[aria-label^='bottom-'] .rotate {
      position: absolute;
      width: 12px;
      height: 12px;
      box-sizing: border-box;
    ...
    /* -18 + 6.5 */
    .blank-edgeless-selected-rect .handle[aria-label='top-left'] {
      left: -12px;
      top: -12px;
    }
    .blank-edgeless-selected-rect .handle[aria-label='top-left'] .resize {
      right: 0;
      bottom: 0;
    }
    .blank-edgeless-selected-rect .handle[aria-label='top-left'] .rotate {
      right: 6px;
      bottom: 6px;
    }

    .blank-edgeless-selected-rect .handle[aria-label='top-right'] {
      top: -12px;
      right: -12px;
    }
    .blank-edgeless-selected-rect .handle[aria-label='top-right'] .resize {
      left: 0;
      bottom: 0;
    }
    .blank-edgeless-selected-rect .handle[aria-label='top-right'] .rotate {
      left: 6px;
      bottom: 6px;
    }

    .blank-edgeless-selected-rect .handle[aria-label='bottom-right'] {
      right: -12px;
      bottom: -12px;
    }
    .blank-edgeless-selected-rect .handle[aria-label='bottom-right'] .resize {
      left: 0;
      top: 0;
    }
    .blank-edgeless-selected-rect .handle[aria-label='bottom-right'] .rotate {
      left: 6px;
      top: 6px;
    }

    .blank-edgeless-selected-rect .handle[aria-label='bottom-left'] {
      bottom: -12px;
      left: -12px;
    }
    .blank-edgeless-selected-rect .handle[aria-label='bottom-left'] .resize {
      right: 0;
      top: 0;
    }
    .blank-edgeless-selected-rect .handle[aria-label='bottom-left'] .rotate {
      right: 6px;
      top: 6px;
    }
    ...
    .blank-edgeless-selected-rect .handle[aria-label='top'],
    .blank-edgeless-selected-rect .handle[aria-label='bottom'],
    .blank-edgeless-selected-rect .handle[aria-label='left'],
    .blank-edgeless-selected-rect .handle[aria-label='right'] {
      border: 0;
      background: transparent;
      border-color: var('--blank-blue');
    }
    ...
    .blank-edgeless-selected-rect .handle[aria-label='top'] .resize,
    .blank-edgeless-selected-rect .handle[aria-label='bottom'] .resize,
    .blank-edgeless-selected-rect .handle[aria-label='left'] .resize,
    .blank-edgeless-selected-rect .handle[aria-label='right'] .resize {
      width: 100%;
      height: 100%;
    }

    .blank-edgeless-selected-rect .handle[aria-label='top'] .resize:after,
    .blank-edgeless-selected-rect .handle[aria-label='bottom'] .resize:after,
    .blank-edgeless-selected-rect .handle[aria-label='left'] .resize:after,
    .blank-edgeless-selected-rect .handle[aria-label='right'] .resize:after {
      position: absolute;
      width: 7px;
      height: 7px;
      box-sizing: border-box;
    ...
    .blank-edgeless-selected-rect .handle .resize::before {
      content: '';
      display: none;
      position: absolute;
      width: 20px;
    ...
    .blank-edgeless-selected-rect[data-mode='scale']
      .handle[aria-label='top-left']
      .resize:hover::before,
    .blank-edgeless-selected-rect[data-scale-direction='top-left'][data-scale-percent]
      .handle[aria-label='top-left']
      .resize::before {
      display: block;
      top: 0px;
    ...
    .blank-edgeless-selected-rect[data-mode='scale']
      ...
      .resize:hover::before,
    .blank-edgeless-selected-rect[data-scale-direction='top-right'][data-scale-percent]
      .handle[aria-label='top-right']
      .resize::before {
      display: block;
      top: 0px;
    ...
    .blank-edgeless-selected-rect[data-mode='scale']
      ...
      .resize:hover::before,
    .blank-edgeless-selected-rect[data-scale-direction='bottom-right'][data-scale-percent]
      .handle[aria-label='bottom-right']
      .resize::before {
      display: block;
      bottom: 0px;
    ...
    .blank-edgeless-selected-rect[data-mode='scale']
      ...
      .resize:hover::before,
    .blank-edgeless-selected-rect[data-scale-direction='bottom-left'][data-scale-percent]
      .handle[aria-label='bottom-left']
      .resize::before {
      display: block;
      bottom: 0px;
    ...
    .blank-edgeless-selected-rect::after {
    ...
    .blank-edgeless-selected-rect[data-scale-direction='top-left']::after {
      display: block;
      top: -20px;
      left: -20px;
      transform: translate(-100%, -100%);
    }
    .blank-edgeless-selected-rect[data-scale-direction='top-right']::after {
      display: block;
      top: -20px;
      right: -20px;
      transform: translate(100%, -100%);
    }
    .blank-edgeless-selected-rect[data-scale-direction='bottom-right']::after {
      display: block;
      bottom: -20px;
      right: -20px;
      transform: translate(100%, 100%);
    }
    .blank-edgeless-selected-rect[data-scale-direction='bottom-left']::after {
      display: block;
      bottom: -20px;
      left: -20px;
      transform: translate(-100%, 100%);
        ...
        repeat(
          ...
          element => {
            ...
            const style = {
              ...
              border: `1px solid var(--blank-primary-color)`,
            };
            return html`<div
  ...
  override render() {
    ...
    return html`
      <style>
        .blank-edgeless-selected-rect .handle[aria-label='right']::after {
          content: '';
          ...
          width: 2px;
          height: 100%;
          background: var(--blank-error-color);
          filter: drop-shadow(-6px 0px 12px rgba(235, 67, 53, 0.35));
        }

        .blank-edgeless-selected-rect .handle[aria-label='bottom']::after {
          content: '';
      ...
      <div
        class="blank-edgeless-selected-rect"
        style=${styleMap({
