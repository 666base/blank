  ...
  return useCallback(
    (link: string) => {
      ...
      const actions: Notification['actions'] = [
        {
          key: 'later',
          label: t['com.blank.payment.downgraded-notify.later'](),
          onClick: () => {},
          buttonProps: {
        ...
        },
        {
          ...
          label: BUILD_CONFIG.isElectron
            ? t['com.blank.payment.downgraded-notify.ok-client']()
            : t['com.blank.payment.downgraded-notify.ok-web'](),
          onClick: () => {
      ...
      const id = notify(
        {
          title: (
            <span className={notifyHeader}>
              {t['com.blank.payment.downgraded-notify.title']()}
            </span>
          ),
          message: t['com.blank.payment.downgraded-notify.content'](),
          alignMessage: 'title',
          icon: null,
          actions,
        },
