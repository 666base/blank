import { ConfirmIcon } from '@blocksuite/blank-components/icons';
...
export const RenameModal = ({
  ...
  return html`
    ...
    <div class="blank-attachment-rename-overlay-mask" @click="${abort}"></div>
    <div class="blank-attachment-rename-container">
      <div class="blank-attachment-rename-input-wrapper">
        <input
          ${ref(inputRef)}
          type="text"
          .value=${fileName}
          ...
          @keydown=${onKeydown}
        />
        <span class="blank-attachment-rename-extension">${extension}</span>
      </div>
      <editor-icon-button
