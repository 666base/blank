import { UserProvider } from '@blocksuite/blank-shared/services';
...
export class BlankMention extends SignalWatcher(
  ...
  static override styles = css`
    .blank-mention {
      ...
      /* Client/baseMedium */
      font-family: Inter;
      font-size: var(--blank-font-size-base);
      font-style: normal;
      font-weight: 500;
    ...
    .blank-mention[data-selected='true'] {
      background: var(--blank-hover-color);
    }
    .blank-mention[data-type='default'] {
      color: ${unsafeCSSVarV2('text/primary')};
    }
    .blank-mention[data-type='removed'] {
      color: ${unsafeCSSVarV2('text/disable')};
    }
    .blank-mention[data-type='error'] {
      color: ${unsafeCSSVarV2('text/disable')};
    }
    .blank-mention[data-type='loading'] {
