...
const useKeyboardShortcutsI18N = () => {
  ...
  return useCallback(
    (key: KeyboardShortcutsI18NKeys) =>
      t[`com.blank.keyboardShortcuts.${key}`](),
    [t]
  );
};
...
const useHeadingKeyboardShortcutsI18N = () => {
  const t = useI18n();
  return useCallback(
    (number: string) => t['com.blank.keyboardShortcuts.heading']({ number }),
    [t]
  );
};
...
export const useMarkdownShortcuts = (): ShortcutsInfo => {
  ...
  return {
    title: t['com.blank.shortcutsTitle.markdownSyntax'](),
    shortcuts,
  };
};
...
export const usePageShortcuts = (): ShortcutsInfo => {
  ...
  return {
    title: t['com.blank.shortcutsTitle.page'](),
    shortcuts,
  };
};
...
export const useEdgelessShortcuts = (): ShortcutsInfo => {
  ...
  return {
    title: t['com.blank.shortcutsTitle.edgeless'](),
    shortcuts,
  };
};
...
export const useGeneralShortcuts = (): ShortcutsInfo => {
  ...
  return {
    title: t['com.blank.shortcutsTitle.general'](),
    shortcuts,
  };
};
