...
export class BlankLinkedDocWidget extends WidgetComponent<RootBlockModel> {
  ...
  private readonly _renderLinkedDocMenu = () => {
    ...
    return html`<blank-mobile-linked-doc-menu
  ...
  private readonly _renderLinkedDocPopover = () => {
    return html`<blank-linked-doc-popover
      .context=${this._context}
    ></blank-linked-doc-popover>`;
  };
...
export const linkedDocWidget = WidgetViewExtension(
  'blank:page',
  BLANK_LINKED_DOC_WIDGET,
  literal`${unsafeStatic(BLANK_LINKED_DOC_WIDGET)}`
);

declare global {
  interface HTMLElementTagNameMap {
    [BLANK_LINKED_DOC_WIDGET]: BlankLinkedDocWidget;
  }
}
