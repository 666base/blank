...
import type {
  ...
  NodeOperation,
} from '@blank/core/desktop/components/navigation-panel';
...
const NavigationPanelFolderNodeFolder = ({
    ...
    return [
      ...
      },
      {
        ...
        view: (
          <FolderRenameSubMenu
            text={t[
              'com.blank.rootAppSidebar.organize.folder.create-subfolder'
            ]()}
            title={t[
              'com.blank.rootAppSidebar.organize.folder.create-subfolder'
            ]()}
  ...
  return (
    ...
    >
      ...
      <AddItemPlaceholder
        label={t['com.blank.rootAppSidebar.organize.folder.new-doc']()}
        onClick={handleNewDoc}
