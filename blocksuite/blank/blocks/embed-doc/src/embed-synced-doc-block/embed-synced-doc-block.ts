...
} from '@blocksuite/blank-inline-reference';
import {
  type AliasInfo,
  type DocMode,
...
import { cloneReferenceInfo } from '@blocksuite/blank-shared/utils';
...
export class EmbedSyncedDocBlockComponent extends EmbedBlockComponent<EmbedSyncedDocModel> {
    ...
    class EmbedSyncedDocWatcher extends LifeCycleWatcher {
      ...
      override mounted(): void {
        ...
        view.viewUpdated.subscribe(payload => {
          if (
            payload.type !== 'block' ||
            payload.view.model.flavour !== 'blank:embed-synced-doc'
          ) {
            return;
          }
    ...
    return this.renderEmbed(
      () => html`
        ...
        >
          ...
          <div
            class=${classMap({
              'blank-embed-synced-doc-header-wrapper': true,
              selected: this.selected$.value,
            })}
          >
            <div class="blank-embed-synced-doc-header">
              <span class="blank-embed-synced-doc-icon"
                >${this.icon$.value}</span
              >
              <span class="blank-embed-synced-doc-title">${this.title$}</span>
            </div>
          </div>
        </div>
      `
  ...
  @query(
    ':scope > .blank-block-component > .embed-block-container > blank-embed-synced-doc-card'
  )
  accessor syncedDocCard: EmbedSyncedDocCard | null = null;

  @query(
    ':scope > .blank-block-component > .embed-block-container > .blank-embed-synced-doc-container > .blank-embed-synced-doc-editor > div > editor-host'
  )
