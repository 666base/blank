import type { EditorIconButton } from '@blocksuite/blank-components/toolbar';
...
export class LinkPopup extends WithDisposable(ShadowlessElement) {
  ...
  private readonly _createTemplate = () => {
    ...
    return html`
      <div class="blank-link-popover create">
        <input
          id="link-input"
          class="blank-link-popover-input"
          type="text"
          spellcheck="false"
  ...
  private readonly _editTemplate = () => {
    ...
    return html`
      <div class="blank-link-edit-popover">
        <div class="blank-edit-area text">
          <input
            ...
            @input=${this._updateConfirmBtn}
          />
          <label class="blank-edit-label" for="text-input">Text</label>
        </div>
        <div class="blank-edit-area link">
          <input
            id="link-input"
            class="blank-edit-input"
            type="text"
            ...
            @input=${this._updateConfirmBtn}
          />
          <label class="blank-edit-label" for="link-input">Link</label>
        </div>
        ${this._confirmBtnTemplate()}
      </div>
    `;
  ...
  @query('.blank-confirm-button')
  accessor confirmButton: EditorIconButton | null = null;

  @property({ attribute: false })
  accessor inlineEditor!: BlankInlineEditor;
