...
export const dataViewVars = {
  cellTextSize: '--blank-data-view-cell-text-size',
  cellTextLineHeight: '--blank-data-view-cell-text-line-height',
};
...
export const shadow2 = css({
  boxShadow: 'var(--blank-shadow-2)',
});

export const dividerH = css({
  height: '1px',
  backgroundColor: 'var(--blank-divider-color)',
  margin: '8px 0',
});
