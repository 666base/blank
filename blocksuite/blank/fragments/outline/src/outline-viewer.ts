import { NoteDisplayMode } from '@blocksuite/blank-model';
...
export const BLANK_OUTLINE_VIEWER = 'blank-outline-viewer';
...
export class OutlineViewer extends SignalWatcher(
  ...
  static override styles = css`
    ...
    .outline-viewer-indicator {
      ...
      border-radius: 1px;
      overflow: hidden;
      background: var(--blank-black-10, rgba(0, 0, 0, 0.1));
    }

    .outline-viewer-indicator.active {
      width: 24px;
      background: var(--blank-text-primary-color);
    }
...
declare global {
  interface HTMLElementTagNameMap {
    [BLANK_OUTLINE_VIEWER]: OutlineViewer;
  }
}
