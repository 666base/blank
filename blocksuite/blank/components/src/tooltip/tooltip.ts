...
const styles = css`
  .blank-tooltip {
    ...
    border-radius: 4px;
    padding: 6px 12px;
    color: var(--blank-v2-tooltips-foreground, var(--blank-white));
    background: var(--blank-v2-tooltips-background, var(--blank-tooltip));
...
const TOOLTIP_ARROW_COLOR =
  'var(--blank-v2-tooltips-background, var(--blank-tooltip))';
 ...
 * // Simple usage
 * html`
 * <blank-tooltip>Content</blank-tooltip>
 * `
 * // With placement
 * html`
 * <blank-tooltip tip-position="top">
 *   Content
 * </blank-tooltip>
 * `
 *
 ...
 *   .autoFlip=${true}
 *   .arrow=${true}
 *   .tooltipStyle=${css`:host { z-index: 0; --blank-tooltip: #fff; }`}
...
export class Tooltip extends LitElement {
  ...
  @property({ attribute: false })
  accessor zIndex: number | string = 'var(--blank-z-index-popover)';
}
