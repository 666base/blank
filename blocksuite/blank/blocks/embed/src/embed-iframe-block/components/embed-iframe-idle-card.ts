...
export class EmbedIframeIdleCard extends WithDisposable(LitElement) {
  static override styles = css`
    ...
    .blank-embed-iframe-idle-card {
      container: blank-embed-iframe-idle-card / size;
    ...
    .blank-embed-iframe-idle-card:hover {
      cursor: pointer;
    }

    .blank-embed-iframe-idle-card.horizontal {
      flex-direction: row;
    ...
    .blank-embed-iframe-idle-card.vertical {
      ...
      @container blank-embed-iframe-idle-card (height < 180px) {
        .icon {
          display: none;
        }
      }
  ...
  override render() {
    ...
    const cardClasses = classMap({
      'blank-embed-iframe-idle-card': true,
