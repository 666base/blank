...
export const container = style({
  width: '100%',
  maxWidth: cssVar('--blank-editor-width'),
  marginLeft: 'auto',
  marginRight: 'auto',
  paddingLeft: cssVar('--blank-editor-side-padding', '24'),
  paddingRight: cssVar('--blank-editor-side-padding', '24'),
  fontSize: cssVar('--blank-font-base'),
  '@container': {
...
export const title = style({
  ...
  fontSize: '15px',
  lineHeight: '24px',
  color: cssVar('--blank-text-primary-color'),
});

export const showButton = style({
  height: '28px',
  borderRadius: '8px',
  border: '1px solid ' + cssVar('--blank-border-color'),
...
globalStyle(`${link} .blank-reference-title`, {
  borderBottom: 'none',
});
