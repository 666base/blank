(function () {
  ...
  function showGlobalErrorPage() {
    ...
    errorEl.innerHTML = [
      ...
      '</style>',
      '<div class="gue">',
      '<img src="/imgs/blank-app-icon.png" width="120" height="120" alt="" style="border-radius:24px" />',
      '<div>',
      '<p class="p1">Unsupported Environment</p>',
      '<p class="p2">',
      'It looks like Blank cannot run in this environment.',
      "Please ensure you are using a supported browser or update your device's operating system to the latest version.",
      'If the issue persists, visit our <a href="https://github.com/666base/blank/issues">support page</a> for further assistance.',
      '</p>',
      '</div>',
      '</div>',
    ].join('');
