import { notify, useConfirmModal } from '@blank/component';
...
export const useEnableCloud = () => {
  ...
  const enableCloud = useCallback(
    async (ws: Workspace | null, options?: ConfirmEnableCloudOptions) => {
      try {
        ...
        console.error(e);
        notify.error({
          title: t['com.blank.workspace.enable-cloud.failed'](),
        });
      }
    },
  ...
  const confirmEnableCloud = useCallback(
    (ws: Workspace, options?: ConfirmEnableCloudOptions) => {
      ...
      openConfirmModal(
        {
          title: t['Enable Blank Cloud'](),
          description: t['Enable Blank Cloud Description'](),
          cancelText: t['com.blank.enableBlankCloudModal.button.cancel'](),
          confirmText:
          ...
          confirmButtonOptions: {
            variant: 'primary',
            ['data-testid' as string]: 'confirm-enable-blank-cloud-button',
          },
          onConfirm: async () =>
