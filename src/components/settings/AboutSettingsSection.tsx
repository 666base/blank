    ...
    <div className="space-y-8 py-8">
      ...
      <section className="pb-2">
        ...
        <p className="text-sm text-text-muted mb-4">
          You are currently using Blank v{appVersion || "..."}
        </p>
        <Button
      ...
      {/* About Section */}
      <section className="pb-2">
        <h2 className="text-xl font-medium mb-1">About Blank</h2>
        <p className="text-sm text-text-muted mb-4">
          Blank is a minimalist markdown blankpad for capturing quick
          ...
          <button
            onClick={() => handleOpenUrl("https://www.ericli.io/blank")}
        ...
        <div className="flex items-center gap-1">
          <Button
            onClick={() => handleOpenUrl("https://github.com/erictli/blank")}
            variant="outline"
            size="md"
            className="gap-1.25"
          >
          ...
          <Button
            onClick={() =>
              handleOpenUrl("https://github.com/erictli/blank/issues")
            }
            variant="ghost"
            size="md"
