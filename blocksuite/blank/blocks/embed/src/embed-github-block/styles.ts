...
export const styles = css`
  .blank-embed-github-block {
    container: blank-embed-github-block / inline-size;
  ...
  .blank-embed-github-content-title {
    display: flex;
    min-height: 22px;
    flex-direction: row;
    gap: 8px;
  ...
  .blank-embed-github-content-title-icons {
    display: flex;
  ...
  .blank-embed-github-content-title-icons img,
  .blank-embed-github-content-title-icons object,
  .blank-embed-github-content-title-icons svg {
    width: 16px;
    height: 16px;
    color: var(--blank-pure-white);
  }

  .blank-embed-github-content-title-site-icon {
    display: flex;
    width: 16px;
    height: 16px;
    justify-content: center;
    ...
    .github-icon {
      fill: var(--blank-black);
      color: var(--blank-black);
    }
  }

  .blank-embed-github-content-title-status-icon {
    display: flex;
    align-items: center;
    gap: 4px;
    padding: 3px 6px;
  ...
  .blank-embed-github-content-title-status-icon.issue.open {
    background: #238636;
  }
  .blank-embed-github-content-title-status-icon.issue.closed.success {
    background: #8957e5;
  }
  .blank-embed-github-content-title-status-icon.issue.closed.failure {
    background: #6e7681;
  }
  .blank-embed-github-content-title-status-icon.pr.open {
    background: #238636;
  }
  .blank-embed-github-content-title-status-icon.pr.draft {
    background: #6e7681;
  }
  .blank-embed-github-content-title-status-icon.pr.merged {
    background: #8957e5;
  }
  .blank-embed-github-content-title-status-icon.pr.closed {
    background: #c03737;
  }

  .blank-embed-github-content-title-status-icon > svg {
    height: 16px;
    width: 16px;
    padding: 2px;
  }

  .blank-embed-github-content-title-status-icon > span {
    padding: 0px 1.5px;
  }

  .blank-embed-github-content-title-text {
    display: -webkit-box;
    -webkit-line-clamp: 1;
  ...
  .blank-embed-github-content-description {
    display: -webkit-box;
    -webkit-line-clamp: 2;
    -webkit-box-orient: vertical;
  ...
  .blank-embed-github-content-assignees {
    display: none;
  }

  .blank-embed-github-content-url {
    display: flex;
    align-items: center;
  ...
  .blank-embed-github-content-url > span {
    display: -webkit-box;
    -webkit-line-clamp: 1;
    -webkit-box-orient: vertical;
  ...
  .blank-embed-github-content-url:hover > span {
    color: var(--blank-link-color);
  }
  .blank-embed-github-content-url:hover .open-icon {
    fill: var(--blank-link-color);
  }

  .blank-embed-github-content-url-icon {
    display: flex;
    align-items: center;
    justify-content: center;
    width: 12px;
  ...
  .blank-embed-github-content-url-icon .open-icon {
    height: 12px;
    width: 12px;
    fill: var(--blank-text-secondary-color);
  }

  .blank-embed-github-banner {
    margin: 12px 0px 0px 12px;
    width: 204px;
    height: 102px;
  }

  .blank-embed-github-banner img,
  .blank-embed-github-banner object,
  .blank-embed-github-banner svg {
    width: 204px;
    height: 102px;
    object-fit: cover;
    border-radius: 4px;
  ...
  .blank-embed-github-block.loading {
    .blank-embed-github-content-title-text {
      color: var(--blank-placeholder-color);
    }
  }

  .blank-embed-github-block.selected {
    .blank-embed-github-content-url > span {
      color: var(--blank-link-color);
    }
    .blank-embed-github-content-url .open-icon {
      fill: var(--blank-link-color);
    }
  }

  .blank-embed-github-block.list {
    .blank-embed-github-content {
      width: 100%;
      flex-direction: row;
      align-items: center;
    ...
    .blank-embed-github-content-repo {
      display: none;
    }

    .blank-embed-github-content-date {
      display: none;
    }
  ...
  .blank-embed-github-block.vertical {
    ...
    .blank-embed-github-content-assignees-text {
      display: -webkit-box;
      -webkit-line-clamp: 1;
      -webkit-box-orient: vertical;
    ...
    .blank-embed-github-content-assignees-text.label {
      width: 72px;
      color: var(--blank-text-primary-color);
      font-weight: 600;
    }

    .blank-embed-github-content-assignees-text.users {
      width: calc(100% - 72px);
      word-break: break-all;
      white-space: normal;
      overflow: hidden;
    ...
    .blank-embed-github-content-assignees-text-users.user {
      color: var(--blank-link-color);
      cursor: pointer;
    }

    .blank-embed-github-content-assignees-text-users.placeholder {
      color: var(--blank-placeholder-color);
    }
  ...
  @container blank-embed-github-block (width < 375px) {
    .blank-embed-github-content {
      width: 100%;
    }

    .blank-embed-github-block:not(.edgeless) .blank-embed-github-banner {
      display: none;
    }
  }
`;
