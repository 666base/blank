import { getSurfaceBlock } from '@blocksuite/blank-block-surface';
import {
  type DocMode,
  ListBlockModel,
  NoteBlockModel,
...
import { NotificationProvider } from '@blocksuite/blank-shared/services';
...
export function createLinkedDocFromSlice(
  ...
  linkedDoc.load(() => {
    ...
    const noteId = linkedDoc.addBlock('blank:note', {}, rootId);
