...
import { DefaultTheme, TextElementModel } from '@blocksuite/blank-model';
import type { RichText } from '@blocksuite/blank-rich-text';
import { ThemeProvider } from '@blocksuite/blank-shared/services';
import { getSelectedRect } from '@blocksuite/blank-shared/utils';
  ...
  static override styles = css`
    .edgeless-text-editor {
      ...
      border: ${EdgelessTextEditor.BORDER_WIDTH}px solid
        var(--blank-primary-color, #1e96eb);
      border-radius: 4px;
