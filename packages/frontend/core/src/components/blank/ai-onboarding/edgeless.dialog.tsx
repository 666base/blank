...
import { type Notification } from '@blank/component/ui/notification';
...
export const AIOnboardingEdgeless = () => {
    ...
    const result: NonNullable<Notification['actions']> = [
      {
        ...
        label: (
          <span className={styles.getStartedButtonText}>
            {t['com.blank.ai-onboarding.edgeless.get-started']()}
          </span>
        ),
        onClick: () => {
      ...
      result.push({
        ...
        label: (
          <span className={styles.purchaseButtonText}>
            {t['com.blank.ai-onboarding.edgeless.purchase']()}
          </span>
        ),
        onClick: () => {
          goToPricingPlans();
  ...
  useEffect(() => {
    ...
    timeoutRef.current = setTimeout(() => {
      ...
      const id = notify(
        {
          title: t['com.blank.ai-onboarding.edgeless.title'](),
          message: t['com.blank.ai-onboarding.edgeless.message'](),
          icon: <AiIcon />,
