import { getBaseFontStyleOptions } from '@blank/core/desktop/dialogs/setting/general-setting/editor/general';
import {
...
export const FontStyleSetting = () => {
  ...
  return (
    <RowLayout label={t['com.blank.mobile.setting.appearance.font']()}>
