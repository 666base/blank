import { updateBlockAlign } from '@blocksuite/blank-block-note';
import { ImageBlockModel, TextAlign } from '@blocksuite/blank-model';
import {
  ActionPlacement,
      ...
      actions: [
        {
          ...
          when(ctx) {
            const supported =
              ctx.store.schema.flavourSchemaMap.has('blank:attachment');
