...
import { requestConnectedFrame } from '@blocksuite/blank-shared/utils';
 ...
 *     Example: `shapeDomRenderer` in `blocksuite/blank/gfx/shape/src/element-renderer/shape-dom/index.ts`.
 ...
 *     Import `DomElementRendererExtension` (e.g., from `@blocksuite/blank-block-surface` or its source location
 *     `blocksuite/blank/blocks/surface/src/extensions/dom-element-renderer.ts`).
 ...
 *     Example: `ShapeDomRendererExtension` in `blocksuite/blank/gfx/shape/src/element-renderer/shape-dom.ts`.
 *
 ...
 *     As seen with `ShapeDomRendererExtension` being registered in `blocksuite/blank/gfx/shape/src/view.ts`.
 *
 ...
 *         `blocksuite/blank/blocks/surface/src/renderer/dom-elements/index.ts`.
 ...
 *         (e.g., from `@blocksuite/blank-block-surface` or its source).
 ...
 *
 * 5.  **Ensure Exports**:
 *     -   The `DomRenderer` class itself should be accessible (e.g., exported from `@blocksuite/blank/blocks/surface`).
