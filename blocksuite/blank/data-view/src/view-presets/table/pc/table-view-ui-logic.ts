...
export class TableViewUI extends DataViewUIBase<TableViewUILogic> {
  override connectedCallback(): void {
    ...
    this.classList.add('blank-database-table', tableViewStyle);
  ...
  private renderTable() {
      ...
      return html`
        <div class="${tableGroupsContainerStyle}">
          ${repeat(
            ...
            group => group.key,
            group =>
              html`<blank-data-view-table-group
    ...
    return html`<blank-data-view-table-group
      .tableViewLogic="${this.logic}"
    ></blank-data-view-table-group>`;
  }
      ...
      <div class="${tableWrapperStyle}" style="${wrapperStyle}">
        ...
        >
          <div
            ...
            class="blank-database-table-container"
