...
import type { ShortcutsInfo } from '../../../../../components/hooks/blank/use-shortcuts';
import {
  useEdgelessShortcuts,
  useGeneralShortcuts,
  useMarkdownShortcuts,
  usePageShortcuts,
} from '../../../../../components/hooks/blank/use-shortcuts';
  ...
  return (
    <>
      <SettingHeader
        ...
        subtitle={t['com.blank.keyboardShortcuts.subtitle']()}
