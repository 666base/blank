import { type NoteBlockModel, NoteDisplayMode } from '@blocksuite/blank-model';
import { createButtonPopper } from '@blocksuite/blank-shared/utils';
...
export const BLANK_OUTLINE_NOTE_CARD = 'blank-outline-note-card';
    ...
    this.disposables.add(
      std.dnd.draggable<NoteCardEntity>({
        ...
        setDragPreview: ({ container, setOffset, location }) => {
          const preview = document.createElement(BLANK_OUTLINE_NOTE_CARD);
...
declare global {
  interface HTMLElementTagNameMap {
    [BLANK_OUTLINE_NOTE_CARD]: OutlineNoteCard;
  }
}
