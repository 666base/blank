...
import type { EmbedLoomModel, EmbedLoomStyles } from '@blocksuite/blank-model';
  ...
  override renderBlock() {
    ...
    return this.renderEmbed(
      () => html`
        ...
        >
          <div class="blank-embed-loom-video">
            ${videoId
              ? html`
                  <div class="blank-embed-loom-video-iframe-container">
                    <iframe
                    ...
                    <div
                      class=${classMap({
                        'blank-embed-loom-video-iframe-overlay': true,
          ...
          <div class="blank-embed-loom-content">
            <div class="blank-embed-loom-content-header">
              <div class="blank-embed-loom-content-title-icon">
                ${titleIcon}
              </div>

              <div class="blank-embed-loom-content-title-text">
                ${titleText}
              </div>
            </div>

            <div class="blank-embed-loom-content-description">
              ${descriptionText}
            </div>

            <div class="blank-embed-loom-content-url" @click=${this.open}>
              <span>loom.com</span>

              <div class="blank-embed-loom-content-url-icon">${OpenIcon}</div>
            </div>
          </div>
        </div>
      `
