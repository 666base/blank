...
export class DatabaseCellContainer extends SignalWatcher(
  ...
  static override styles = css`
    blank-database-virtual-cell-container {
      display: flex;
      align-items: start;
      width: 100%;
      border: none;
    ...
    blank-database-virtual-cell-container uni-lit > *:first-child {
      padding: 6px;
    }
  `;
  ...
  override connectedCallback() {
    ...
    if (style) {
      style.borderBottom = '1px solid var(--blank-border-color)';
      style.borderRight = '1px solid var(--blank-border-color)';
    }
  }
...
declare global {
  interface HTMLElementTagNameMap {
    'blank-database-virtual-cell-container': DatabaseCellContainer;
  }
}
