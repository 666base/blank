import { ListBlockModel, ParagraphBlockModel } from '@blocksuite/blank-model';
import type { IndentContext } from '@blocksuite/blank-shared/types';
import {
...
export const indentParagraphCommand: Command<{
  ...
  if (
    ...
    indentContext.flavour !== 'blank:paragraph'
  ) {
    console.warn(
  ...
  // update collapsed state of blank list
  if (
