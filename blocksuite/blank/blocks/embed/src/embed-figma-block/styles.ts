...
export const styles = css`
  ...
  .blank-embed-figma img,
  .blank-embed-figma object,
  .blank-embed-figma svg {
    width: 100%;
    height: 100%;
    object-fit: cover;
    border-radius: 4px;
  ...
  .blank-embed-figma-iframe-container {
    height: 100%;
    position: relative;
  }

  .blank-embed-figma-iframe-container > iframe {
    width: 100%;
    height: 100%;
    border-radius: 4px;
    border: none;
  ...
  .blank-embed-figma-iframe-overlay {
    position: absolute;
    top: 0;
    left: 0;
    width: 100%;
  ...
  .blank-embed-figma-iframe-overlay.hide {
    display: none;
  }

  .blank-embed-figma-content {
    display: block;
    flex-direction: column;
    width: 100%;
    height: fit-content;
  ...
  .blank-embed-figma-content-header {
    display: flex;
    flex-direction: row;
    gap: 8px;
    align-items: center;
  ...
  .blank-embed-figma-content-title-icon {
    display: flex;
    width: 20px;
    height: 20px;
  ...
  .blank-embed-figma-content-title-icon img,
  .blank-embed-figma-content-title-icon object,
  .blank-embed-figma-content-title-icon svg {
    width: 20px;
    height: 20px;
    fill: var(--blank-background-primary-color);
  }

  .blank-embed-figma-content-title-text {
    flex: 1 0 0;
  ...
  .blank-embed-figma-content-description {
    height: 40px;
  ...
  .blank-embed-figma-content-description::after {
    content: '...';
    position: absolute;
    right: 0;
    bottom: 0;
  ...
  .blank-embed-figma-content-url > span {
    display: -webkit-box;
    -webkit-line-clamp: 1;
    -webkit-box-orient: vertical;
  ...
  .blank-embed-figma-content-url:hover > span {
    color: var(--blank-link-color);
  }
  .blank-embed-figma-content-url:hover .open-icon {
    fill: var(--blank-link-color);
  }

  .blank-embed-figma-content-url-icon {
    display: flex;
    align-items: center;
    justify-content: center;
    width: 12px;
  ...
  .blank-embed-figma-content-url-icon svg {
    height: 12px;
    width: 12px;
    fill: ${unsafeCSSVarV2('icon/primary')};
  }

  .blank-embed-figma-block.selected {
    .blank-embed-figma-content-url > span {
      color: var(--blank-link-color);
    }
    .blank-embed-figma-content-url .open-icon {
      fill: var(--blank-link-color);
    }
  }
`;
