...
export class GroupSetting extends SignalWatcher(
  ...
  protected override render() {
    ...
    return html`
      ...
      >
        <div
          style="padding:0 4px;font-size:12px;color:var(--blank-text-secondary-color);line-height:20px;"
        >
          Groups
        </div>
    ...
    menu.group({
      items: [
        menu.action({
          ...
          postfix: html`
            <div
              style="display:flex;align-items:center;gap:4px;font-size:14px;line-height:20px;color:var(--blank-text-secondary-color);margin-left:8px;"
              class="dv-icon-16"
            >
            ...
            items: [
              menu.dynamic(() => [
                menu.subMenu({
                  ...
                  postfix: html`
                    <div
                      style="display:flex;align-items:center;gap:4px;font-size:14px;line-height:20px;color:var(--blank-text-secondary-color);margin-left:30px;"
                    >
