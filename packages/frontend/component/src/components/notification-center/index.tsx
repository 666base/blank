...
function NotificationCard(props: NotificationCardProps): ReactNode {
  ...
  return (
    <Toast.Root
      ...
      data-testid="blank-notification"
      onMouseEnter={() => {
        setExpand(true);
      }}
      onMouseMove={() => {
          ...
          {notification.action && (
            ...
            >
              {notification.actionLabel ??
                t['com.blank.keyboardShortcuts.undo']()}
            </div>
          )}
...
/**
 * @deprecated use `import { NotificationCenter } from '@blank/component'` instead
 */
