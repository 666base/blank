...
import type { GetInviteInfoQuery } from '@blank/graphql';
...
export const SentRequestPage = ({
  ...
  return (
    <AuthPageContainer
      title={t['com.blank.sent-request-to-join-workspace.title']()}
      subtitle={
        <div className={styles.lineHeight}>
          <Trans
            i18nKey="com.blank.sent-request-to-join-workspace.description"
            components={{
              1: (
