...
DefaultAvatar.args = {
  name: 'Blank',
  url: 'https://blank.pro/favicon-96.png',
  size: 50,
};
...
export const ColorfulFallbackWithDifferentSize: StoryFn<AvatarProps> = args => (
  <>
    <Avatar {...args} size={20} colorfulFallback name="Blank" />
    <Avatar {...args} size={40} colorfulFallback name="Blank" />
    <Avatar {...args} size={60} colorfulFallback name="Blank" />
  </>
);
...
export const CustomizeBorderRadius: StoryFn<AvatarProps> = args => (
  <div style={{ display: 'flex', gap: 4 }}>
    <Avatar {...args} size={60} colorfulFallback name="Blank" rounded={10} />
