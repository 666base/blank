...
import type { BaseSelection, Workspace } from '@blocksuite/blank/store';
...
export function mockDocModeService(editor: TestBlankEditorContainer) {
...
export function mockNotificationService(editor: TestBlankEditorContainer) {
