...
const styles = css`
  ...
  blank-database-column-stats:hover .stats-cell {
    opacity: 1;
  }

  .stats-cell:hover,
  blank-database-column-stats-cell.active .stats-cell {
    opacity: 1;
...
declare global {
  interface HTMLElementTagNameMap {
    'blank-database-column-stats-cell': DatabaseColumnStatsCell;
  }
}
