import { embedNoteContentStyles } from '@blocksuite/blank-block-embed';
import {
  EMBED_CARD_HEIGHT,
  EMBED_CARD_WIDTH,
...
export const blockStyles = css`
  ...
  blank-embed-synced-doc-block[data-page-mode] {
  ...
  .edgeless-block-portal-embed
    > blank-embed-synced-doc-block[data-nested-editor] {
    position: relative;
    display: block;
    left: 0px;
    top: 0px;
  ...
  .edgeless-block-portal-embed
    .blank-embed-synced-doc-editor
    .blank-page-root-block-container {
    width: 100%;
  }

  .edgeless-block-portal-embed .blank-embed-synced-doc-container.edgeless {
    display: block;
    padding: 0;
    width: 100%;
    height: calc(${EMBED_CARD_HEIGHT.syncedDoc}px + 36px);
  }
  .edgeless-block-portal-embed .blank-embed-synced-doc-container.surface {
    border: 1px solid var(--blank-border-color);
  }

  blank-embed-synced-doc-block[data-nested-editor],
  blank-embed-edgeless-synced-doc-block[data-nested-editor] {
    .blank-embed-synced-doc-container.page {
  ...
  .blank-embed-synced-doc-container {
    border: 1px solid transparent;
    border-radius: 8px;
    overflow: hidden;
  }
  .blank-embed-synced-doc-container.comment-highlighted {
    outline: 2px solid ${unsafeCSSVarV2('block/comment/highlightUnderline')};
  }
  .blank-embed-synced-doc-container.show-hover-border:hover {
  ...
  .blank-embed-synced-doc-container.edgeless {
    display: block;
    width: 100%;
    height: calc(${EMBED_CARD_HEIGHT.syncedDoc}px + 36px);
  }
  .blank-embed-synced-doc-header-wrapper {
    position: absolute;
    top: 0;
    left: 0;
    height: 34px;
  ...
  .blank-embed-synced-doc-header-wrapper.selected {
    opacity: 1;
    transition: all 0.23s ease;
  }
  .blank-embed-synced-doc-header {
    display: flex;
    align-items: center;
    width: 100%;
    height: 100%;
  ...
  .blank-embed-synced-doc-header svg {
    flex-shrink: 0;
  }
  .blank-embed-synced-doc-icon {
    line-height: 0;
    color: ${unsafeCSSVarV2('icon/primary')};
  }
  .blank-embed-synced-doc-title {
    font-size: 14px;
    font-weight: 600;
    line-height: 22px;
    margin-left: 8px;
  ...
  .blank-embed-synced-doc-editor-overlay {
    position: absolute;
    top: 0;
    left: 0;
    width: 100%;
  ...
  .blank-embed-synced-doc-editor-empty {
    display: flex;
    align-items: center;
    width: 100%;
    height: 100%;
  ...
  .blank-embed-synced-doc-container.surface
    > .blank-embed-synced-doc-editor
    > .blank-embed-synced-doc-editor-empty {
    left: 0;
  ...
  .blank-embed-synced-doc-editor-empty > span {
  ...
  .blank-embed-synced-doc-container
    > .blank-embed-synced-doc-editor.blank-page-viewport {
    background: transparent;
  }

  .blank-embed-synced-doc-container > .blank-embed-synced-doc-editor {
    width: 100%;
    height: 100%;
  }

  .blank-embed-synced-doc-editor .blank-page-root-block-container {
    width: 100%;
    max-width: 100%;
  }
...
export const cardStyles = css`
  ...
  .blank-embed-synced-doc-card-content {
  ...
  .blank-embed-synced-doc-card-content-title {
    display: flex;
    flex-direction: row;
    gap: 8px;
    align-items: center;
  ...
  .blank-embed-synced-doc-card-content-title-icon {
    display: flex;
    width: 16px;
    height: 16px;
    justify-content: center;
  ...
  .blank-embed-synced-doc-card-content-title-icon svg {
    width: 16px;
    height: 16px;
    fill: var(--blank-background-primary-color);
  }

  .blank-embed-synced-doc-card-content-title-text {
    display: -webkit-box;
    -webkit-line-clamp: 1;
  ...
  .blank-embed-synced-doc-content-note.render {
    display: none;
    overflow: hidden;
    pointer-events: none;
  }
  ...
  .blank-embed-synced-doc-content-note.default {
    display: -webkit-box;
    -webkit-line-clamp: 2;
    -webkit-box-orient: vertical;
    white-space: normal;
  ...
  .blank-embed-synced-doc-card-content-date,
  .blank-embed-synced-doc-card-content-reload {
    display: flex;
    flex-grow: 1;
  ...
  .blank-embed-synced-doc-card-content-date > span {
    display: -webkit-box;
    -webkit-line-clamp: 1;
    -webkit-box-orient: vertical;
  ...
  .blank-embed-synced-doc-card-content-reload-button {
    display: flex;
    flex-direction: row;
    align-items: center;
    gap: 4px;
  ...
  .blank-embed-synced-doc-card-content-reload-button svg {
    width: 12px;
    height: 12px;
  }
  .blank-embed-synced-doc-card-content-reload-button > span {
    display: -webkit-box;
    -webkit-line-clamp: 1;
    -webkit-box-orient: vertical;
    word-break: break-all;
  ...
  .blank-embed-synced-doc-card-banner {
  ...
  .blank-embed-synced-doc-card-banner.render {
    display: none;
  }
  .blank-embed-synced-doc-card-banner img,
  .blank-embed-synced-doc-card-banner object,
  .blank-embed-synced-doc-card-banner svg {
    width: 204px;
    max-width: 100%;
    height: 102px;
    object-fit: cover;
  ...
  .blank-embed-synced-doc-card.loading,
  .blank-embed-synced-doc-card.deleted,
  .blank-embed-synced-doc-card.error {
    .blank-embed-linked-doc-content-note.render {
      display: none;
    }
    .blank-embed-linked-doc-content-note.default {
      display: block;
    }
    .blank-embed-synced-doc-card-banner.render {
      display: none;
    }
    .blank-embed-synced-doc-card-banner.default {
      display: block;
    }
    .blank-embed-synced-doc-card-content-date {
      display: none;
  ...
  .blank-embed-synced-doc-card:not(.loading).deleted,
  .blank-embed-synced-doc-card:not(.loading).error {
    background: var(--blank-background-secondary-color);
  }
  .blank-embed-synced-doc-card:not(.loading):not(.error):not(
      .surface
    ).deleted {
  ...
  .blank-embed-synced-doc-card:not(.loading):not(.error):not(.deleted):not(
      .note-empty
    ).cycle {
    .blank-embed-synced-doc-content-note.render {
      display: block;
  ...
  .blank-embed-synced-doc-card.surface:not(.cycle) {
    ...
    .blank-embed-synced-doc-card-content-note {
      margin: 0 auto;
      flex-grow: 0;
    }
  ...
  .blank-embed-synced-doc-card.surface:not(.loading):not(.error):not(
      .deleted
    ).cycle {
  ...
  .blank-embed-synced-doc-edgeless-header-wrapper {
    position: relative;
