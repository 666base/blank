  ...
  return new Promise<void>((resolve, reject) => {
    ...
    iframe.onload = async () => {
      ...
      doc.write(`<!DOCTYPE html><html><head><style>@media print {
                ...
                :root, body {
                  --blank-text-primary: #000 !important;
                  --blank-text-secondary: #111 !important;
                  --blank-text-tertiary: #333 !important;
                  --blank-background-primary: #fff !important;
                  --blank-background-secondary: #fff !important;
                  --blank-background-tertiary: #fff !important;
                }
                ...
                :root {
                  --blank-note-shadow-box: none !important;
                  --blank-note-shadow-sticker: none !important;
                }
      ...
      iframe.contentWindow.document
        .write(`<!DOCTYPE html><html><head><style>@media print {
              ...
              :root, body {
                ...
                --blank-background-secondary: #fff !important;
                --blank-background-tertiary: #fff !important;
                --blank-background-code-block: #f5f5f5 !important;
                --blank-quote-color: #e3e3e3 !important;
                --blank-border-color: #e3e3e3 !important;
              }
              body, [data-theme='dark'] {
                color: #000 !important;
                background: #fff !important;
