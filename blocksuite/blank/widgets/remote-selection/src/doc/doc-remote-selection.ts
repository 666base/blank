...
import { getSelectionRectsCommand } from '@blocksuite/blank-shared/commands';
import { EMBED_BLOCK_MODEL_LIST } from '@blocksuite/blank-shared/consts';
...
export const BLANK_DOC_REMOTE_SELECTION_WIDGET =
  'blank-doc-remote-selection-widget';

export class BlankDocRemoteSelectionWidget extends WidgetComponent {
  ...
  private _getCursorRect(selections: BaseSelection[]): SelectionRect | null {
    ...
    if (this.block.model.flavour !== 'blank:page') {
                ...
                >
                  <div
                    style="${styleMap({
                      ...
                      maxWidth: '160px',
                      padding: '0 3px',
                      border: '1px solid var(--blank-pure-black-20)',
...
declare global {
  interface HTMLElementTagNameMap {
    [BLANK_DOC_REMOTE_SELECTION_WIDGET]: BlankDocRemoteSelectionWidget;
  }
}
