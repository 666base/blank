...
export function coreEffects() {
  ...
  customElements.define('blank-lit-icon', BlankLitIcon);
  customElements.define('data-view-group-setting', GroupSetting);
  customElements.define('blank-multi-tag-select', MultiTagSelect);
  customElements.define('data-view-group-title-boolean-view', BooleanGroupView);
  customElements.define('blank-multi-tag-view', MultiTagView);
  ...
  customElements.define('blank-data-view-record-detail', RecordDetail);
}
