import { Button, Input, Menu, toast } from '@blank/component';
...
export const CreateOrEditTag = ({
  ...
  const onConfirm = useCallback(() => {
    ...
    if (
      ...
      return toast(t['com.blank.tags.create-tag.toast.exist']());
    }
    if (!tagMeta) {
      tagList.createTag(tagName.trim(), tagIcon);
      toast(t['com.blank.tags.create-tag.toast.success']());
      onClose();
      return;
    }
    ...
    toast(t['com.blank.tags.edit-tag.toast.success']());
    onClose();
    return;
  ...
  return (
    ...
    >
      ...
      <Input
        placeholder={t['com.blank.tags.create-tag.placeholder']()}
        inputStyle={{ fontSize: 'var(--blank-font-xs)' }}
        onEnter={onConfirm}
        value={tagName}
