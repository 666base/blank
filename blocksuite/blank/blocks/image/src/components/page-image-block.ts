...
export class ImageBlockPageComponent extends SignalWatcher(
  ...
  static override styles = css`
    ...
    blank-page-image .blank-image-status {
      position: absolute;
      left: 18px;
      bottom: 18px;
    }

    blank-page-image .resizable-img {
      position: relative;
      max-width: 100%;
    }

    blank-page-image .resizable-img img {
      width: 100%;
      height: 100%;
    }

    blank-page-image .comment-highlighted {
...
declare global {
  interface HTMLElementTagNameMap {
    'blank-page-image': ImageBlockPageComponent;
  }
}
