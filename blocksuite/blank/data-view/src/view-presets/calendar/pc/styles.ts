...
export const calendarViewStyles = css`
  blank-data-view-calendar {
    ...
    --calendar-grid-border-color: color-mix(
      in srgb,
      var(--blank-border-color) 58%,
      transparent
    );
    --calendar-entry-bg: color-mix(
      in srgb,
      var(--blank-primary-color) 12%,
      var(--blank-background-primary-color)
    );
    --calendar-entry-hover-bg: color-mix(
      in srgb,
      var(--blank-primary-color) 18%,
      var(--blank-background-primary-color)
    );
    --calendar-entry-text-color: color-mix(
      in srgb,
      var(--blank-primary-color) 72%,
  ...
  .calendar-day.is-outside {
    background: color-mix(
      in srgb,
      var(--blank-background-secondary-color) 55%,
      var(--blank-background-primary-color)
    );
  }
  ...
  .calendar-day:not(.is-outside):hover {
    background: color-mix(
      in srgb,
      var(--blank-primary-color) 2%,
      var(--blank-background-primary-color)
    );
  }

  .calendar-day.is-drop-target {
    box-shadow: inset 0 0 0 1px var(--blank-primary-color);
    background: color-mix(in srgb, var(--blank-primary-color) 8%, transparent);
  }

  .calendar-day.is-today {
    background: color-mix(
      in srgb,
      var(--blank-primary-color) 6%,
      var(--blank-background-primary-color)
    );
  }
  ...
  .calendar-day.is-outside .calendar-day-number {
    color: color-mix(
      in srgb,
      var(--blank-text-secondary-color) 60%,
      transparent
    );
  }
  ...
  .calendar-entry:focus-visible {
    outline: 1px solid var(--blank-primary-color);
    outline-offset: 1px;
  }
  ...
  .calendar-entry-property {
    ...
    padding: 1px 6px;
    border-radius: 4px;
    background: color-mix(in srgb, var(--blank-pure-white) 80%, transparent);
    color: var(--blank-text-primary-color);
    font-size: 10px;
    font-weight: 500;
    line-height: 14px;
  ...
  .calendar-resize-handle::after {
    ...
    border-radius: 1px;
    background: var(--blank-icon-secondary);
  }

  .calendar-resize-handle:hover::after {
    background: var(--blank-primary-color);
  }
  ...
  .calendar-entry-preview {
    ...
    box-sizing: border-box;
    border-radius: 4px;
    border: 1.5px dashed var(--blank-primary-color);
    background: color-mix(in srgb, var(--blank-primary-color) 6%, transparent);
    color: var(--blank-primary-color);
    font-size: 12px;
    line-height: 18px;
    white-space: nowrap;
  ...
  .calendar-day.is-today .calendar-new-row:hover {
    background: color-mix(
      in srgb,
      var(--blank-primary-color) 88%,
      var(--blank-pure-white)
    );
  }
  ...
  .calendar-empty-month-hint {
    ...
    border: 1px solid
      color-mix(in srgb, var(--blank-primary-color) 18%, transparent);
    border-radius: 6px;
    background: color-mix(
      in srgb,
      var(--blank-background-primary-color) 92%,
      var(--blank-primary-color)
    );
    box-shadow: var(--blank-menu-shadow);
    box-sizing: border-box;
  }
