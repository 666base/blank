import { NoteConfigExtension } from '@blocksuite/blank-block-note';
import {
  DefaultTool,
  getBgGridGap,
...
import { isSingleMindMapNode } from '@blocksuite/blank-gfx-mindmap';
...
> {
  ...
  get surfaceBlockModel() {
    return this.model.children.find(
      child => child.flavour === 'blank:surface'
