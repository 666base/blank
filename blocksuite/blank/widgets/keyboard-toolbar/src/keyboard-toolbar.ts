...
import { type VirtualKeyboardProviderWithAction } from '@blocksuite/blank-shared/services';
...
export const BLANK_KEYBOARD_TOOLBAR = 'blank-keyboard-toolbar';

@requiredProperties({
  config: PropTypes.object,
  rootComponent: PropTypes.instanceOf(BlockComponent),
})
export class BlankKeyboardToolbar extends SignalWatcher(
