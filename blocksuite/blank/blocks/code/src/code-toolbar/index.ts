...
export const BLANK_CODE_TOOLBAR_WIDGET = 'blank-code-toolbar-widget';
export class BlankCodeToolbarWidget extends WidgetComponent<
  CodeBlockModel,
  CodeBlockComponent
> {
  ...
  private readonly _setHoverController = () => {
    ...
    this._hoverController = new HoverController(
      ...
      ({ abortController }) => {
        ...
        return {
          template: html`<blank-code-toolbar
            .context=${context}
