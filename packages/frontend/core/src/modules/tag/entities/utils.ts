...
// map var(--blank-tag-xxx) colors to var(--blank-chip-label-xxx)
...
// hack: map var(--blank-tag-xxx)/var(--blank-chip-label-xxx) colors to var(--blank-palette-line-xxx)
export const databaseTagColorToBlankLabel = (color: string) => {
...
export const blankLabelToDatabaseTagColor = (color: string) => {
