...
import { EdgelessDraggableElementController } from '@blocksuite/blank-widget-edgeless-toolbar';
...
export class EdgelessTemplatePanel extends WithDisposable(LitElement) {
  static override styles = css`
    ...
    .edgeless-templates-panel {
      ...
      height: 568px;
      border-radius: 12px;
      background-color: var(--blank-background-overlay-panel-color);
    ...
    .search-bar {
      padding: 21px 24px;
      font-size: 18px;
      color: var(--blank-secondary);
      border-bottom: 1px solid var(--blank-divider-color);
    ...
    .category-entry:hover {
      color: var(--blank-text-primary-color);
      background-color: var(--blank-background-tertiary-color);
    }
    ...
    .template-item > svg {
      ...
      width: 135px;
      height: 80px;
      color: var(--blank-background-primary-color);
    }
    ...
    /* .template-item:hover::before {
      ...
      background-color: var(--blank-primary-color);
    ...
    .template-item:hover::after {
      ...
      height: 100%;
      box-sizing: border-box;
      border: 1px solid var(--blank-black-10);
      border-radius: 4px;
    ...
    .template-item.loading > blank-template-loading {
      position: absolute;
      left: 50%;
      top: 50%;
      transform: translate(-50%, -50%);
    ...
    .arrow {
      ...
      color: var(--blank-background-overlay-panel-color);
    }
  `;
                      ...
                      return html`
                        ...
                        >
                          ...
                          ${template === this._loadingTemplate
                            ? html`<blank-template-loading></blank-template-loading>`
                            : nothing}
                          ${template.name
                            ? html`<blank-tooltip
                                .offset=${12}
