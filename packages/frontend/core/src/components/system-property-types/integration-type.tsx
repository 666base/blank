...
import { INTEGRATION_TYPE_NAME_MAP } from '@blank/core/modules/integration/constant';
import type { IntegrationType } from '@blank/core/modules/integration/type';
...
export const IntegrationTypeGroupHeader = ({
  ...
  const text =
    groupId === 'readwise'
      ? t['com.blank.integration.readwise.name']()
      : groupId
        ? groupId
        : 'No integrations';
