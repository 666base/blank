...
export class BlankLatexNode extends SignalWatcher(
  ...
  static override styles = css`
    ...
    blank-latex-node .blank-latex:hover {
      background: ${unsafeCSSVar('hoverColor')};
    }
    blank-latex-node .blank-latex[data-selected='true'] {
      background: ${unsafeCSSVar('hoverColor')};
    }

    blank-latex-node .error-placeholder {
      display: flex;
      padding: 2px 4px;
  ...
  override render() {
    return html`<span class="blank-latex" data-selected=${this.selected}
  ...
  @property({ attribute: false })
  accessor editor!: InlineEditor<BlankTextAttributes>;
