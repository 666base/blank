import { EmbedIframeConfigExtension } from '@blocksuite/blank-shared/services';
...
/**
 * Blank domains that should be excluded from generic embedding
 * These are based on the centralized cloud constants and known Blank domains
 */
const BLANK_DOMAINS = [
  'app.blank.pro', // Stable cloud domain
  'insider.blank.pro', // Beta/internal cloud domain
  'blank.fail', // Canary cloud domain
  'toeverything.app', // Safety measure for potential future use
  'apple.getblankapp.com', // Cloud domain for Apple app
];
 ...
 * Allows HTTPS URLs but excludes Blank domains
