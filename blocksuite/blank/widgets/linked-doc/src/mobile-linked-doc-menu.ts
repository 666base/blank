...
import { VirtualKeyboardProvider } from '@blocksuite/blank-shared/services';
...
export const BLANK_MOBILE_LINKED_DOC_MENU = 'blank-mobile-linked-doc-menu';

@requiredProperties({
  context: PropTypes.object,
})
export class BlankMobileLinkedDocMenu extends SignalWatcher(
