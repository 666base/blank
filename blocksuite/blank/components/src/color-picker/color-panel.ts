import type { Color, ColorScheme, Palette } from '@blocksuite/blank-model';
import { DefaultTheme, resolveColor } from '@blocksuite/blank-model';
import { unsafeCSSVarV2 } from '@blocksuite/blank-shared/theme';
import { ColorEvent } from '@blocksuite/blank-shared/utils';
...
export class EdgelessColorButton extends LitElement {
  static override styles = css`
    ...
    :host([active])::after {
      border: 1.5px solid var(--blank-primary-color);
    }
  `;
