...
import type { FrameBlockProps } from '@blocksuite/blank-model';
import { encodeClipboardBlobs } from '@blocksuite/blank-shared/adapters';
...
export function createNewPresentationIndexes(
  ...
  const frames = raw
    .filter((block): block is FrameSnapshot => {
      ...
      return data?.flavour === 'blank:frame';
    })
