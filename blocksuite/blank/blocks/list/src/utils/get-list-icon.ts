...
import { getNumberPrefix } from '@blocksuite/blank-shared/utils';
import {
  BulletedList01Icon,
  BulletedList02Icon,
  BulletedList03Icon,
  ...
  switch (model.props.type) {
    case 'bulleted':
      return html`<div
        ...
        class="blank-list-block__prefix"
        @click=${onClick}
      >
    ...
    case 'numbered':
      return html`<div
        contenteditable="false"
        class="blank-list-block__prefix blank-list-block__numbered"
        @click=${onClick}
      >
    ...
    case 'todo':
      return html`<div
        contenteditable="false"
        class=${`blank-list-block__prefix blank-list-block__todo-prefix ${model.store.readonly ? 'readonly' : ''}`}
        @click=${onClick}
      >
        ${model.props.checked
