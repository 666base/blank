import { MenuItem, MenuSeparator, MobileMenuSub } from '@blank/component';
import { sortPagesByDate } from '@blank/core/desktop/pages/workspace/detail-page/tabs/journal';
import {
  type DocRecord,
  DocService,
  DocsService,
} from '@blank/core/modules/doc';
...
const ActivityBlock = ({
  ...
  const title =
    name === 'created'
      ? t['com.blank.journal.created-today']()
      : t['com.blank.journal.updated-today']();
  return (
    <>
      ...
      {list.length > 0 ? (
        ...
        <div className={styles.empty}>
          {name === 'created'
            ? t['com.blank.journal.daily-count-created-empty-tips']()
            : t['com.blank.journal.daily-count-updated-empty-tips']()}
        </div>
      )}
    </>
  );
  ...
  return (
    <>
      ...
      <MobileMenuSub
        ...
        title={t['com.blank.m.selector.journal-menu.today-activity']()}
      >
        {t['com.blank.m.selector.journal-menu.today-activity']()}
      </MobileMenuSub>
      {suffix}
    </>
  );
