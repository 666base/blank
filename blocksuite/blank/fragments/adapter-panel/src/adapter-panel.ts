import type { Store, TransformerMiddleware } from '@blocksuite/blank/store';
import {
  type HtmlAdapter,
...
export const BLANK_ADAPTER_PANEL = 'blank-adapter-panel';
  ...
  override render() {
    return html`
      <div class="adapters-container">
        <blank-adapter-panel-header
          .updateActiveContent=${this._updateActiveContent}
        ></blank-adapter-panel-header>
        <blank-adapter-panel-body></blank-adapter-panel-body>
      </div>
    `;
  }
...
declare global {
  interface HTMLElementTagNameMap {
    [BLANK_ADAPTER_PANEL]: AdapterPanel;
  }
}
