...
export class TableRowView extends SignalWatcher(
  ...
  static override styles = css`
    .blank-database-block-row:has(.row-select-checkbox.selected) {
      background: var(--blank-primary-color-04);
    }
    .blank-database-block-row:has(.row-select-checkbox.selected)
      .row-selected-bg {
      position: relative;
    ...
    .blank-database-block-row.selected > .database-cell {
    ...
    .blank-database-block-row .show-on-hover-row {
      visibility: hidden;
      opacity: 0;
    }
    .blank-database-block-row:hover .show-on-hover-row {
      visibility: visible;
      opacity: 1;
    }
    .blank-database-block-row:has(.active) .show-on-hover-row {
      visibility: visible;
      opacity: 1;
    }
    .blank-database-block-row:has([data-editing='true']) .show-on-hover-row {
      visibility: hidden;
      opacity: 0;
    }
    ...
    .row-op {
      ...
      padding: 4px;
      border-radius: 4px;
      box-shadow: var(--blank-button-shadow);
  ...
  get groupKey() {
    return this.closest<TableGroup>('blank-data-view-table-group')?.group?.key;
  }
  ...
  override connectedCallback() {
    ...
    this.classList.add('blank-database-block-row', 'database-row');
  }
            ...
            <div style="display: flex;">
              ...
              >
                <div
                  ...
                  border-radius: 2px;
                  height: 12px;
                  background-color: var(--blank-placeholder-color);"
                ></div>
              </div>
              <row-select-checkbox
