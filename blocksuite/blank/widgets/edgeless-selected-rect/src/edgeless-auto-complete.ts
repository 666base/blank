...
import { ToolbarRegistryIdentifier } from '@blocksuite/blank-shared/services';
import type { SelectedRect } from '@blocksuite/blank-shared/types';
import { handleNativeRangeAtPoint } from '@blocksuite/blank-shared/utils';
...
export class EdgelessAutoComplete extends WithDisposable(LitElement) {
  static override styles = css`
    ...
    .edgeless-auto-complete-arrow-wrapper
      ...
      border: 1px solid var(--blank-white-10);
      box-shadow: var(--blank-shadow-1);
