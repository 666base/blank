...
export class ParagraphBlockComponent extends CaptionedBlockComponent<ParagraphBlockModel> {
  ...
  private readonly _isInDatabase = () => {
    ...
    while (parent && parent !== document.body) {
      if (parent.tagName.toLowerCase() === 'blank-database') {
        return true;
      }
  ...
  override renderBlock(): TemplateResult<1> {
    ...
    return html`
      ${style}
      <style>
        .blank-paragraph-block-container[data-has-collapsed-siblings='false']
          blank-paragraph-heading-icon
          .heading-icon {
      ...
      <div
        class=${classMap({
          'blank-paragraph-block-container': true,
      ...
      >
        <div
          class=${classMap({
            'blank-paragraph-rich-text-wrapper': true,
            [type$.value]: true,
          ...
          ${this.inEdgelessText
            ...
            : html`
                <div
                  ...
                  class=${classMap({
                    'blank-paragraph-placeholder': true,
  ...
  override accessor blockContainerStyles = {
    margin: 'var(--blank-paragraph-margin, 10px 0)',
  };
}
