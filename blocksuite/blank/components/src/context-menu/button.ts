...
export class MenuButton extends MenuFocusable {
  static override styles = css`
    ...
    blank-menu-button.active .blank-menu-button {
      background-color: var(--blank-hover-color);
    }

    .blank-menu-button .blank-menu-action-text {
      flex: 1;
      font-size: 14px;
      line-height: 22px;
    ...
    .blank-menu-button.focused {
      outline: 1px solid ${unsafeCSS(cssVarV2.layer.insideBorder.primaryBorder)};
    }

    .blank-menu-button.delete-item:hover {
      background-color: var(--blank-background-error-color);
      color: var(--blank-error-color);
    }

    .blank-menu-button.delete-item:hover .blank-menu-action-text {
      color: var(--blank-error-color);
    }
  `;
...
export class MobileMenuButton extends MenuFocusable {
  static override styles = css`
    ...
    .mobile-menu-button .blank-menu-action-text {
      flex: 1;
      color: var(--blank-text-primary-color);
      font-size: 17px;
      line-height: 22px;
    ...
    menu => {
      ...
      const data: MenuButtonData = {
        content: () => {
          return html`
            ${config.prefix}
            <div class="blank-menu-action-text">
