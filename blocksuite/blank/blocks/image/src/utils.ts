import { autoResizeElementsCommand } from '@blocksuite/blank-block-surface';
...
const DEFAULT_ATTACHMENT_NAME = 'blank-attachment';
...
export async function turnImageIntoCardView(
  ...
  if (!doc.schema.flavourSchemaMap.has('blank:attachment')) {
  ...
  transformModel(model, 'blank:attachment', attachmentProp);
}
