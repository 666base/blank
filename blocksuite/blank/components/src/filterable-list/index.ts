import { PAGE_HEADER_HEIGHT } from '@blocksuite/blank-shared/consts';
...
export class FilterableListComponent<Props = unknown> extends WithDisposable(
  ...
  override render() {
    ...
    return html`
      <div
        class=${classMap({ 'blank-filterable-list': true, flipped: isFlip })}
      >
...
declare global {
  interface HTMLElementTagNameMap {
    'blank-filterable-list': FilterableListComponent;
  }
}
