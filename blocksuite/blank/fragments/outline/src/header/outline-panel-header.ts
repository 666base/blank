...
export const BLANK_OUTLINE_PANEL_HEADER = 'blank-outline-panel-header';
  ...
  override render() {
    ...
    return html`<div class=${styles.container}>
      ...
      <div class=${styles.notePreviewSettingContainer}>
        <blank-outline-note-preview-setting-menu></blank-outline-note-preview-setting-menu>
      </div>`;
  }
...
declare global {
  interface HTMLElementTagNameMap {
    [BLANK_OUTLINE_PANEL_HEADER]: OutlinePanelHeader;
  }
}
