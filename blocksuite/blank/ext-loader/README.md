# @blocksuite/blank-ext-loader

Blocksuite extension loader system for Blank, providing a structured way to manage and load extensions in different contexts.
...
```typescript
import { BaseExtensionProvider } from '@blocksuite/blank-ext-loader';
import { z } from 'zod';
...
```typescript
import { StoreExtensionProvider, StoreExtensionManager } from '@blocksuite/blank-ext-loader';
import { z } from 'zod';
...
```typescript
import { ViewExtensionProvider, ViewExtensionManager } from '@blocksuite/blank-ext-loader';
import { z } from 'zod';
