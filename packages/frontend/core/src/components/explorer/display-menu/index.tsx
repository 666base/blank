...
import type {
  GroupByParams,
  OrderByParams,
} from '@blank/core/modules/collection-rules/types';
    ...
    <div className={styles.displayMenuContainer}>
      ...
      >
        <div className={styles.subMenuSelectorContainer}>
          <span>{t['com.blank.explorer.display-menu.grouping']()}</span>
      ...
      >
        <div className={styles.subMenuSelectorContainer}>
          <span>{t['com.blank.explorer.display-menu.ordering']()}</span>
          <span className={styles.subMenuSelectorSelected}>
  ...
  return (
    ...
    >
      <Button className={className} style={style}>
        {t['com.blank.explorer.display-menu.button']()}
      </Button>
    </Menu>
  );
};
