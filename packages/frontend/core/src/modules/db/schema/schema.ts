...
export const Blank_WORKSPACE_DB_SCHEMA = {
  folders: {
...
export type BlankWorkspaceDbSchema = typeof Blank_WORKSPACE_DB_SCHEMA;

export type DocProperties = ORMEntity<BlankWorkspaceDbSchema['docProperties']>;
export type DocCustomPropertyInfo = ORMEntity<
  BlankWorkspaceDbSchema['docCustomPropertyInfo']
>;

export const Blank_WORKSPACE_USERDATA_DB_SCHEMA = {
  favorite: {
  ...
  docIntegrationRef: {
    ...
    /**
     * Identify **blank user** and **integration type** and **integration account**
...
export type BlankWorkspaceUserdataDbSchema =
  typeof Blank_WORKSPACE_USERDATA_DB_SCHEMA;
export type DocIntegrationRef = ORMEntity<
  BlankWorkspaceUserdataDbSchema['docIntegrationRef']
>;
