...
export const BLANK_SCROLL_ANCHORING_WIDGET = 'blank-scroll-anchoring-widget';

export class BlankScrollAnchoringWidget extends WidgetComponent {
  ...
  #moveToAnchorInEdgeless(id: string) {
    ...
    if (parentComponent && parentComponent.flavour === 'blank:note') {
