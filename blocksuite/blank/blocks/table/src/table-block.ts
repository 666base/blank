...
import type { TableBlockModel } from '@blocksuite/blank-model';
...
import { VirtualPaddingController } from '@blocksuite/blank-shared/utils';
...
export const TableBlockComponentName = 'blank-table';
        ...
        >
          <table class=${tableWrapper} ${ref(this.table$)}>
            ...
            ${IS_MOBILE || this.dataManager.readonly$.value
              ? nothing
              : html`<blank-table-add-button
                  style="display: contents;"
                  .dataManager=${this.dataManager}
                ></blank-table-add-button>`}
            ${html`<blank-table-selection-layer
              style="display: contents;"
              .selectionController=${this.selectionController}
              .getRowRect=${this.getRowRect}
              .getColumnRect=${this.getColumnRect}
              .getAreaRect=${this.getAreaRect}
            ></blank-table-selection-layer>`}
          </table>
        </div>
      </div>
    `;
