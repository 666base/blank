import type { SurfaceRefBlockComponent } from '@blocksuite/blank/blocks/surface-ref';
import { BlankReference } from '@blocksuite/blank/inlines/reference';
import type {
...
import type { BlockComponent, EditorHost } from '@blocksuite/blank/std';
import type { Block, BlockModel } from '@blocksuite/blank/store';
...
function resolvePeekInfoFromPeekTarget(
  ...
  if (element) {
    if (element instanceof BlankReference) {
