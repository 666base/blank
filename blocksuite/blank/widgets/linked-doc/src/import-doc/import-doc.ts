...
export class ImportDoc extends WithDisposable(LitElement) {
  ...
  private _openLearnImportLink(event: MouseEvent) {
    event.stopPropagation();
    window.open(
      'https://blank.pro/blog/import-your-data-from-notion-into-blank',
      '_blank'
    );
  }
  ...
  override render() {
    ...
    return html`
      ...
      <div class="container">
        ...
        <div>
          Blank will gradually support more file formats for import.
          <a href="https://blank.pro/redirect/discord" target="_blank"
            >Provide feedback.</a
          >
        </div>
        ...
        <div class="button-container">
          ...
          >
            ...
            >
              ${HelpIcon}
              <blank-tooltip>
                Learn how to Import your Notion pages into Blank.
              </blank-tooltip>
            </div>
          </icon-button>
          <icon-button
        ...
        <!-- <div class="footer">
        <div>Migrate from other versions of Blank?</div>
      </div> -->
      </div>
    `;
  }
