...
import { getBlockProps, matchModels } from '@blocksuite/blank-shared/utils';
    ...
    conversionsActionGroup,
    {
      ...
      run: ctx => {
        ...
        ctx.track('BlockCreated', {
          ...
          module: 'toolbar',
          segment: 'toolbar',
          blockType: 'blank:embed-linked-doc',
          ...
          .pipe(({ std, draftedModels }, next) => {
            (async () => {
              ...
              std.store.addBlock(
                'blank:paragraph',
                {
                  text: new Text<BlankTextAttributes>([
                    {
