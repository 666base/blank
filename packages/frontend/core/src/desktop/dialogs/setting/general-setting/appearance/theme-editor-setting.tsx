...
export const ThemeEditorSetting = () => {
  ...
  return (
    <SettingRow
      name={t['com.blank.appearanceSettings.customize-theme.title']()}
      desc={t['com.blank.appearanceSettings.customize-theme.description']()}
    >
      <div style={{ display: 'flex', gap: 16 }}>
        {modified ? (
          <Button
            ...
            prefix={<DeleteIcon />}
          >
            {t['com.blank.appearanceSettings.customize-theme.reset']()}
          </Button>
        ) : null}
        <Button onClick={open}>
          {t['com.blank.appearanceSettings.customize-theme.open']()}
        </Button>
      </div>
    </SettingRow>
  );
