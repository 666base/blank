...
const styles = css`
  blank-database-virtual-column-stats {
  ...
  protected override render() {
    ...
    return html`
      ${repeat(
        ...
        col => col.id,
        col => {
          return html`<blank-database-virtual-column-stats-cell
            .column=${col}
            .group=${this.group}
          ></blank-database-virtual-column-stats-cell>`;
        }
      )}
    `;
  }
...
declare global {
  interface HTMLElementTagNameMap {
    'blank-database-virtual-column-stats': VirtualDataBaseColumnStats;
  }
}
