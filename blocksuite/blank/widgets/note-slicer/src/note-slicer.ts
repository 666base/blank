...
import { EDGELESS_BLOCK_CHILD_PADDING } from '@blocksuite/blank-shared/consts';
import { TelemetryProvider } from '@blocksuite/blank-shared/services';
import { getRectByBlockComponent } from '@blocksuite/blank-shared/utils';
import type { EdgelessSelectedRectWidget } from '@blocksuite/blank-widget-edgeless-selected-rect';
