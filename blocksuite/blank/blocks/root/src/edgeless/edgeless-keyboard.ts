...
import { EdgelessTextBlockComponent } from '@blocksuite/blank-block-edgeless-text';
import {
  FrameTool,
  type PresentToolOption,
} from '@blocksuite/blank-block-frame';
import {
  DefaultTool,
...
import {
  ...
  EraserTool,
  HighlighterTool,
} from '@blocksuite/blank-gfx-brush';
import {
  ConnectorTool,
  mountConnectorLabelEditor,
} from '@blocksuite/blank-gfx-connector';
import {
  createGroupFromSelectedCommand,
  ungroupCommand,
} from '@blocksuite/blank-gfx-group';
import {
  getNearestTranslation,
  isElementOutsideViewport,
  isSingleMindMapNode,
} from '@blocksuite/blank-gfx-mindmap';
import { NoteTool } from '@blocksuite/blank-gfx-note';
import { PanTool } from '@blocksuite/blank-gfx-pointer';
import { mountShapeTextEditor, ShapeTool } from '@blocksuite/blank-gfx-shape';
import { TextTool } from '@blocksuite/blank-gfx-text';
import {
