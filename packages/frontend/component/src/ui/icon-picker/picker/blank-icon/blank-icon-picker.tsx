...
import * as styles from './blank-icon-picker.css';
              ...
              <div className={pickerStyles.groupGrid}>
                {recentIcons.map(iconName => (
                  <IconButton
                    ...
                    key={iconName}
                    icon={
                      <BlankIconRenderer style={{ color }} name={iconName} />
                    }
              ...
              {filteredIcons.map(icon => {
                return (
                  <IconButton
                    ...
                    key={icon.name}
                    icon={
                      <BlankIconRenderer style={{ color }} name={icon.name} />
                    }
