import { HoverController } from '@blocksuite/blank-components/hover';
import { PeekViewProvider } from '@blocksuite/blank-components/peek';
import type { FootNote } from '@blocksuite/blank-model';
import { CitationProvider } from '@blocksuite/blank-shared/services';
...
import { isValidUrl, normalizeUrl } from '@blocksuite/blank-shared/utils';
...
export class BlankFootnoteNode extends WithDisposable(ShadowlessElement) {
