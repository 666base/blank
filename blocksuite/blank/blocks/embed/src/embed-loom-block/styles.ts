...
export const styles = css`
  ...
  .blank-embed-loom-video {
    flex-grow: 1;
    width: 100%;
  }

  .blank-embed-loom-video img,
  .blank-embed-loom-video object,
  .blank-embed-loom-video svg {
    width: 100%;
    height: 100%;
    object-fit: cover;
    border-radius: 4px;
  ...
  .blank-embed-loom-video-iframe-container {
    position: relative;
    height: 100%;
  }

  .blank-embed-loom-video-iframe-container > iframe {
    width: 100%;
    height: 100%;
    border-radius: 4px;
  }

  .blank-embed-loom-video-iframe-overlay {
    position: absolute;
    top: 0;
    left: 0;
    width: 100%;
  ...
  .blank-embed-loom-video-iframe-overlay.hide {
    display: none;
  }

  .blank-embed-loom-content {
    display: flex;
    flex-direction: column;
    width: 100%;
    height: fit-content;
  ...
  .blank-embed-loom-content-header {
    display: flex;
    flex-direction: row;
    gap: 8px;
    align-items: center;
  ...
  .blank-embed-loom-content-title-icon {
    display: flex;
    width: 20px;
    height: 20px;
  ...
  .blank-embed-loom-content-title-icon img,
  .blank-embed-loom-content-title-icon object,
  .blank-embed-loom-content-title-icon svg {
    width: 20px;
    height: 20px;
    fill: var(--blank-background-primary-color);
  }

  .blank-embed-loom-content-title-text {
    flex: 1 0 0;
  ...
  .blank-embed-loom-content-description {
    display: -webkit-box;
    -webkit-line-clamp: 2;
    -webkit-box-orient: vertical;
  ...
  .blank-embed-loom-content-url > span {
    display: -webkit-box;
    -webkit-line-clamp: 1;
    -webkit-box-orient: vertical;
  ...
  .blank-embed-loom-content-url:hover > span {
    color: var(--blank-link-color);
  }
  .blank-embed-loom-content-url:hover .open-icon {
    fill: var(--blank-link-color);
  }

  .blank-embed-loom-content-url-icon {
    display: flex;
    align-items: center;
    justify-content: center;
    width: 12px;
  ...
  .blank-embed-loom-content-url-icon .open-icon {
    height: 12px;
    width: 12px;
    fill: var(--blank-text-secondary-color);
  }

  .blank-embed-loom-block.loading {
    .blank-embed-loom-content-title-text {
      color: var(--blank-placeholder-color);
    }
  }

  .blank-embed-loom-block.selected {
    .blank-embed-loom-content-url > span {
      color: var(--blank-link-color);
    }
    .blank-embed-loom-content-url .open-icon {
      fill: var(--blank-link-color);
    }
  }
`;
