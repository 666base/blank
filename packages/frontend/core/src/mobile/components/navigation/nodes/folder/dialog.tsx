...
export const FolderCreateTip = ({
  ...
  const parent = parentName
    ? parentName
    : t['com.blank.m.explorer.folder.root']();

  const tip = input
    ? t['com.blank.m.explorer.folder.new-tip-not-empty']({
        value: input,
        parent,
      })
    : t['com.blank.m.explorer.folder.new-tip-empty']({ parent });
...
export const FolderRenameSubMenu = ({
  ...
  const t = useI18n();
  const title = propsTitle || t['com.blank.m.explorer.folder.rename']();
...
export const FolderRenameDialog = ({
  ...
  const t = useI18n();
  const title =
    propsTitle || t['com.blank.m.explorer.folder.new-dialog-title']();
  const confirmText =
    propsConfirmText || t['com.blank.m.explorer.folder.rename-confirm']();
