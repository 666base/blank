...
beforeEach(() => {
  vi.stubGlobal('location', { origin: 'http://blank.pro' });
});
...
const testCases: [string, ReturnType<typeof resolveLinkToDoc>][] = [
  ...
  [
    'http://blank.pro/workspace/48__RTCSwASvWZxyAk3Jw/-Uge-K6SYcAbcNYfQ5U-j?blockIds=xxxx',
    {
      workspaceId: '48__RTCSwASvWZxyAk3Jw',
      docId: '-Uge-K6SYcAbcNYfQ5U-j',
      blockIds: ['xxxx'],
  ...
  ['http://blank.pro/workspace/48__RTCSwASvWZxyAk3Jw/all', null],
  ['http://blank.pro/workspace/48__RTCSwASvWZxyAk3Jw/collection', null],
  ['http://blank.pro/workspace/48__RTCSwASvWZxyAk3Jw/tag', null],
  ['http://blank.pro/workspace/48__RTCSwASvWZxyAk3Jw/trash', null],
  [
