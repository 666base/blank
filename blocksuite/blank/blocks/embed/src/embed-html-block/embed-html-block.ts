import type { EmbedHtmlModel, EmbedHtmlStyles } from '@blocksuite/blank-model';
  ...
  override renderBlock(): unknown {
    ...
    return this.renderEmbed(() => {
      if (!this.model.props.html) {
        return html` <div class="blank-html-empty">Empty</div>`;
      }
      return html`
        <div
          class=${classMap({
            'blank-embed-html-block': true,
        ...
        >
          <div class="blank-embed-html">
            <div class="blank-embed-html-iframe-container">
              ...
              <div
                class=${classMap({
                  'blank-embed-html-iframe-overlay': true,
          ...
          <div class="blank-embed-html-title">
            <div class="blank-embed-html-title-icon">${HtmlIcon}</div>

            <div class="blank-embed-html-title-text">${titleText}</div>
          </div>
        </div>
      `;
    });
