import { ErrorMessage, Skeleton } from '@blank/component';
import { UserQuotaService } from '@blank/core/modules/cloud';
...
import { UserPlanButton } from '../../blank/auth/user-plan-button';
      ...
      <div className={styles.usageLabel}>
        <div>
          <span className={styles.usageLabelTitle}>
            {t['com.blank.user-info.usage.cloud']()}
          </span>
