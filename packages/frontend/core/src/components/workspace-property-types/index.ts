...
export const DateFilterMethod = {
  after: 'com.blank.filter.after',
  before: 'com.blank.filter.before',
  between: 'com.blank.filter.between',
  'last-3-days': 'com.blank.filter.last 3 days',
  'last-7-days': 'com.blank.filter.last 7 days',
  'last-15-days': 'com.blank.filter.last 15 days',
  'last-30-days': 'com.blank.filter.last 30 days',
  'this-week': 'com.blank.filter.this week',
  'this-month': 'com.blank.filter.this month',
  'this-quarter': 'com.blank.filter.this quarter',
  'this-year': 'com.blank.filter.this year',
} as const;
...
export const WorkspacePropertyTypes = {
  tags: {
    icon: TagIcon,
    value: TagsValue,
    name: 'com.blank.page-properties.property.tags',
    uniqueId: 'tags',
    renameable: false,
    description: 'com.blank.page-properties.property.tags.tooltips',
    filterMethod: {
      'include-all': 'com.blank.filter.contains all',
      'include-any-of': 'com.blank.filter.contains one of',
      'not-include-all': 'com.blank.filter.does not contains all',
      'not-include-any-of': 'com.blank.filter.does not contains one of',
      'is-not-empty': 'com.blank.filter.is not empty',
      'is-empty': 'com.blank.filter.is empty',
    },
    allowInGroupBy: true,
    allowInOrderBy: true,
  ...
  text: {
    icon: TextIcon,
    value: TextValue,
    name: 'com.blank.page-properties.property.text',
    description: 'com.blank.page-properties.property.text.tooltips',
    filterMethod: {
      is: 'com.blank.editCollection.rules.include.is',
      'is-not': 'com.blank.editCollection.rules.include.is-not',
      'is-not-empty': 'com.blank.filter.is not empty',
      'is-empty': 'com.blank.filter.is empty',
    },
    allowInGroupBy: true,
  ...
  number: {
    icon: NumberIcon,
    value: NumberValue,
    name: 'com.blank.page-properties.property.number',
    description: 'com.blank.page-properties.property.number.tooltips',
    filterMethod: {
      '<': '<',
      '=': '=',
      '≠': '≠',
  ...
  checkbox: {
    ...
    value: CheckboxValue,
    name: 'com.blank.page-properties.property.checkbox',
    description: 'com.blank.page-properties.property.checkbox.tooltips',
    filterMethod: {
      is: 'com.blank.editCollection.rules.include.is',
      'is-not': 'com.blank.editCollection.rules.include.is-not',
    },
  ...
  date: {
    icon: DateTimeIcon,
    value: DateValue,
    name: 'com.blank.page-properties.property.date',
    description: 'com.blank.page-properties.property.date.tooltips',
    filterMethod: {
      'is-not-empty': 'com.blank.filter.is not empty',
      'is-empty': 'com.blank.filter.is empty',
      ...DateFilterMethod,
  ...
  createdBy: {
    ...
    name: 'com.blank.page-properties.property.createdBy',
    description: 'com.blank.page-properties.property.createdBy.tooltips',
    allowInGroupBy: true,
    allowInOrderBy: true,
    filterMethod: {
      include: 'com.blank.filter.contains all',
    },
  ...
  updatedBy: {
    ...
    name: 'com.blank.page-properties.property.updatedBy',
    description: 'com.blank.page-properties.property.updatedBy.tooltips',
    allowInGroupBy: true,
    allowInOrderBy: true,
    filterMethod: {
      include: 'com.blank.filter.contains all',
  ...
  updatedAt: {
    ...
    name: 'com.blank.page-properties.property.updatedAt',
    description: 'com.blank.page-properties.property.updatedAt.tooltips',
    renameable: false,
    allowInGroupBy: true,
    allowInOrderBy: true,
    filterMethod: {
  ...
  createdAt: {
    icon: HistoryIcon,
    value: CreateAtValue,
    name: 'com.blank.page-properties.property.createdAt',
    description: 'com.blank.page-properties.property.createdAt.tooltips',
    renameable: false,
    allowInGroupBy: true,
    allowInOrderBy: true,
    filterMethod: {
  ...
  docPrimaryMode: {
    ...
    name: 'com.blank.page-properties.property.docPrimaryMode',
    description: 'com.blank.page-properties.property.docPrimaryMode.tooltips',
    allowInGroupBy: true,
    allowInOrderBy: true,
    filterMethod: {
      is: 'com.blank.editCollection.rules.include.is',
  ...
  journal: {
    icon: TodayIcon,
    value: JournalValue,
    name: 'com.blank.page-properties.property.journal',
    description: 'com.blank.page-properties.property.journal.tooltips',
    allowInGroupBy: true,
    allowInOrderBy: true,
    filterMethod: {
      is: 'com.blank.editCollection.rules.include.is',
  ...
  edgelessTheme: {
    ...
    name: 'com.blank.page-properties.property.edgelessTheme',
    description: 'com.blank.page-properties.property.edgelessTheme.tooltips',
    showInDocList: 'stack',
    allowInGroupBy: true,
    allowInOrderBy: true,
  ...
  pageWidth: {
    ...
    name: 'com.blank.page-properties.property.pageWidth',
    description: 'com.blank.page-properties.property.pageWidth.tooltips',
    showInDocList: 'stack',
    allowInGroupBy: true,
    allowInOrderBy: true,
  ...
  template: {
    icon: TemplateIcon,
    value: TemplateValue,
    name: 'com.blank.page-properties.property.template',
    renameable: true,
    description: 'com.blank.page-properties.property.template.tooltips',
    showInDocList: 'stack',
    allowInGroupBy: true,
    allowInOrderBy: true,
