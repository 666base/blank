import { popupTargetFromElement } from '@blocksuite/blank-components/context-menu';
...
const styles = css`
  blank-data-view-kanban-card {
    ...
    background-color: var(--blank-background-kanban-card-color);
  }

  blank-data-view-kanban-card:hover {
    background-color: var(--blank-hover-color);
  }

  blank-data-view-kanban-card .card-header {
    padding: 8px;
    display: flex;
    flex-direction: column;
    gap: 8px;
  ...
  blank-data-view-kanban-card .card-header-title uni-lit {
    width: 100%;
  }
  ...
  blank-data-view-kanban-card .card-header-title {
    font-size: var(--data-view-cell-text-size);
    line-height: var(--data-view-cell-text-line-height);
  }

  blank-data-view-kanban-card .card-header-icon {
    padding: 4px;
  ...
  blank-data-view-kanban-card .card-header-icon svg {
    width: 16px;
    height: 16px;
  ...
  blank-data-view-kanban-card .card-body {
    display: flex;
    flex-direction: column;
    padding: 8px;
    gap: 4px;
  ...
  blank-data-view-kanban-card:hover .card-ops {
    visibility: visible;
  }
  blank-data-view-kanban-card:has(.active) .card-ops {
    visibility: visible;
  }

  blank-data-view-kanban-card:has([data-editing='true']) .card-ops {
    visibility: hidden;
  }
...
export class KanbanCard extends SignalWatcher(
  ...
  private readonly contextMenu = (e: MouseEvent) => {
    ...
    if (selection) {
      ...
      const ref = target.closest('blank-data-view-kanban-cell') ?? this;
      popCardMenu(
        this.kanbanViewLogic,
    ...
    return html` <div class="card-body">
      ${repeat(
        ...
        column => {
          ...
          return html` <blank-data-view-kanban-cell
            .contentOnly="${false}"
  ...
  override render() {
    ...
    this.style.border = this.isFocus$.value
      ? '1px solid var(--blank-primary-color)'
      : '';
    return html`
...
declare global {
  interface HTMLElementTagNameMap {
    'blank-data-view-kanban-card': KanbanCard;
  }
}
