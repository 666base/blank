...
export class DatabaseTitle extends SignalWatcher(
  ...
  static override styles = css`
    ...
    .blank-database-title .text {
      user-select: none;
      opacity: 0;
      white-space: pre-wrap;
    }

    .blank-database-title[data-title-focus='false'] textarea {
      opacity: 0;
    }

    .blank-database-title[data-title-focus='false'] .text {
    ...
    .blank-database-title [data-title-empty='true']::before {
      content: 'Untitled';
      position: absolute;
      pointer-events: none;
      color: var(--blank-text-primary-color);
    ...
    .blank-database-title [data-title-focus='true']::before {
      color: var(--blank-placeholder-color);
    }

    .blank-database-title.comment-highlighted {
  ...
  get database() {
    return this.closest<DatabaseBlockComponent>('blank-database');
  }
...
declare global {
  interface HTMLElementTagNameMap {
    'blank-database-title': DatabaseTitle;
  }
}
