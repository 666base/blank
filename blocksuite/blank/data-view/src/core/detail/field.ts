...
export class RecordField extends SignalWatcher(
  ...
  static override styles = css`
    ...
    blank-data-view-record-field .icon {
      display: flex;
      align-items: center;
      width: 16px;
      height: 16px;
    ...
    blank-data-view-record-field .icon svg {
      width: 16px;
      height: 16px;
    ...
    .field-content blank-database-number-cell .number {
      text-align: left;
  ...
  changeEditing = (editing: boolean) => {
    const selection = this.closest('blank-data-view-record-detail')?.selection;
    if (selection) {
      selection.selection = {
...
declare global {
  interface HTMLElementTagNameMap {
    'blank-data-view-record-field': RecordField;
  }
}
