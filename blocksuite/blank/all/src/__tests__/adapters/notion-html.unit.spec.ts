...
import { DEFAULT_IMAGE_PROXY_ENDPOINT } from '@blocksuite/blank-shared/consts';
import {
  AssetsManager,
  type BlockSnapshot,
  MemoryBlobCRUD,
...
describe('notion html to snapshot', () => {
  ...
  test('bookmark', async () => {
    const html = `<div class="page-body">
      <figure id="ed3d2ae9-62f5-433a-9049-9ddbd1c81ac5"><a href="https://blank.pro/" class="bookmark source">
          <div class="bookmark-info">
            <div class="bookmark-text">
              <div class="bookmark-title">Blank - All In One KnowledgeOS</div>
              <div class="bookmark-description">The universal editor that lets you work, play, present or
                create just about anything.</div>
            </div>
            <div class="bookmark-href"><img src="https://blank.pro/favicon-96.png"
                class="icon bookmark-icon" />https://blank.pro/</div>
          </div><img src="https://blank.pro/og.png" class="bookmark-image" />
        </a></figure>
    </div>`;
          ...
          <tbody>
            <tr id="ed3d2ae9-62f5-433a-9049-9ddbd1c81ac5">
              <td class="cell-title"><a
                  href="https://www.notion.so/https-blank-pro-ed3d2ae962f5433a90499ddbd1c81ac5?pvs=21">https://blank.pro</a>
              </td>
          ...
          children: [
            {
              ...
              props: {
                text: {
                  ...
                  delta: [
                    {
                      insert: 'https://blank.pro',
                      attributes: {
                        link: 'https://www.notion.so/https-blank-pro-ed3d2ae962f5433a90499ddbd1c81ac5?pvs=21',
                      },
                    },
                  ],
                },
