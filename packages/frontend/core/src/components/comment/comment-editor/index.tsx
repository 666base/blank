import { IconButton, notify, toast } from '@blank/component';
import { LitDocEditor, type PageEditor } from '@blank/core/blocksuite/editors';
import { SnapshotHelper } from '@blank/core/modules/comment/services/snapshot-helper';
import type { CommentAttachment } from '@blank/core/modules/comment/types';
import { PeekViewService } from '@blank/core/modules/peek-view';
import { downloadResourceWithUrl } from '@blank/core/utils/resource';
import { DebugLogger } from '@blank/debug';
import { getAttachmentFileIconRC } from '@blocksuite/blank/components/icons';
import { type RichText, selectTextModel } from '@blocksuite/blank/rich-text';
import { ViewportElementExtension } from '@blocksuite/blank/shared/services';
import { openFilesWith } from '@blocksuite/blank/shared/utils';
import { type DocSnapshot, nanoid, Store } from '@blocksuite/blank/store';
import {
  ArrowUpBigIcon,
  AttachmentIcon,
  CloseIcon,
