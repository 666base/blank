...
import { type DocCommentEntity } from '@blank/core/modules/comment/entities/doc-comment';
import { CommentPanelService } from '@blank/core/modules/comment/services/comment-panel-service';
import { DocCommentManagerService } from '@blank/core/modules/comment/services/doc-comment-manager';
import type {
  CommentAttachment,
  DocComment,
  DocCommentReply,
} from '@blank/core/modules/comment/types';
...
import { useAsyncCallback } from '../../hooks/blank-async-hooks';
    ...
    <Menu
      ...
      items={
        <>
          ...
          >
            {t['com.blank.comment.filter.show-resolved']()}
          </MenuItem>
          <MenuItem
          ...
          >
            {t['com.blank.comment.filter.only-my-replies']()}
          </MenuItem>
          <MenuItem
          ...
          >
            {t['com.blank.comment.filter.only-current-mode']()}
          </MenuItem>
        </>
      }
    >
        ...
        <>
          {canReply ? (
            <MenuItem onClick={onReply} disabled={!!disabled || !!resolved}>
              {t['com.blank.comment.reply']()}
            </MenuItem>
          ) : null}
          {canCopyLink ? (
            <MenuItem onClick={onCopyLink} disabled={disabled}>
              {t['com.blank.comment.copy-link']()}
            </MenuItem>
          ) : null}
          {canEdit ? (
...
const CommentItem = ({
  ...
  const handleDelete = useAsyncCallback(
    async (e: React.MouseEvent) => {
      e.stopPropagation();
      openConfirmModal({
        title: t['com.blank.comment.delete.confirm.title'](),
        description: t['com.blank.comment.delete.confirm.description'](),
      ...
      {filteredAndSortedComments.length === 0 &&
        ...
        !loading && (
          <div className={styles.empty}>
            {t['com.blank.comment.no-comments']()}
          </div>
        )}
      {loading &&
        filteredAndSortedComments.length === 0 &&
...
const ReplyItem = ({
  ...
  const handleDelete = useAsyncCallback(async () => {
    openConfirmModal({
      title: t['com.blank.comment.reply.delete.confirm.title'](),
      description: t['com.blank.comment.reply.delete.confirm.description'](),
      confirmText: t['Delete'](),
      cancelText: t['Cancel'](),
      confirmButtonOptions: {
        variant: 'error',
      ...
      <>
        ...
        >
          <div className={styles.collapsedRepliesTitle}>
            {t['com.blank.comment.reply.show-more']({
