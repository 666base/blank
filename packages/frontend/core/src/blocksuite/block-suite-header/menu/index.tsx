import { notify, toast, useConfirmModal } from '@blank/component';
import {
  Menu,
  MenuItem,
  MenuSeparator,
  MenuSub,
} from '@blank/component/ui/menu';
import { PageHistoryModal } from '@blank/core/components/blank/page-history-modal';
...
import { Export, MoveToTrash } from '@blank/core/components/page-list';
import { IsFavoriteIcon } from '@blank/core/components/pure/icons';
import { useDetailPageHeaderResponsive } from '@blank/core/desktop/pages/workspace/detail-page/use-header-responsive';
import { WorkspaceDialogService } from '@blank/core/modules/dialogs';
import { EditorService } from '@blank/core/modules/editor';
import { OpenInAppService } from '@blank/core/modules/open-in-app/services';
...
const PageHeaderMenuItem = ({
  ...
  const handleSwitchMode = useCallback(() => {
    ...
    notify.success({
      title:
        primaryMode === 'page'
          ? t['com.blank.toastMessage.defaultMode.edgeless.title']()
          : t['com.blank.toastMessage.defaultMode.page.title'](),
      message:
        primaryMode === 'page'
          ? t['com.blank.toastMessage.defaultMode.edgeless.message']()
          : t['com.blank.toastMessage.defaultMode.page.message'](),
    });
  ...
  const ResponsiveMenuItems = (
    <>
      {hideShare ? (
        ...
        >
          {t['com.blank.share-menu.shareButton']()}
        </MenuSub>
      ) : null}
      <MenuSeparator />
    </>
  ...
  return (
    <>
      ...
      >
        {primaryMode === 'page'
          ? t['com.blank.editorDefaultMode.edgeless']()
          : t['com.blank.editorDefaultMode.page']()}
      </MenuItem>
      <MenuItem
      ...
      {currentMode === 'page' ? (
        ...
        >
          {t['com.blank.header.option.view-toc']()}
        </MenuItem>
      ) : (
        <MenuItem
        ...
        >
          {t['com.blank.header.option.view-frame']()}
        </MenuItem>
      )}
      <MenuItem
      ...
      >
        {t['com.blank.history.view-history-version']()}
      </MenuItem>
      <MenuSeparator />
      {!isJournal && (
        <MenuItem
      ...
      {BUILD_CONFIG.isWeb && workspace.flavour !== 'local' ? (
        ...
        >
          {t['com.blank.header.option.open-in-desktop']()}
        </MenuItem>
      ) : null}
    </>
  );
