...
export const styles = css`
  ...
  .blank-embed-html img,
  .blank-embed-html object,
  .blank-embed-html svg {
    width: 100%;
    height: 100%;
    object-fit: cover;
    border-radius: 4px;
  ...
  .blank-embed-html-iframe-container {
    position: relative;
    width: 100%;
    height: 100%;
    border-radius: 4px 4px 0px 0px;
    box-shadow: var(--blank-shadow-1);
    overflow: hidden;
  }
  ...
  .embed-html-block-iframe-wrapper blank-menu {
    min-width: 296px;
  }

  .embed-html-block-iframe-wrapper blank-menu .settings-header {
    padding: 7px 12px;
    font-weight: 500;
  ...
  .blank-embed-html-iframe-overlay {
    position: absolute;
    top: 0;
    left: 0;
    width: 100%;
  ...
  .blank-embed-html-iframe-overlay.hide {
    display: none;
  }

  .blank-embed-html-title {
    height: fit-content;
    display: flex;
    align-items: center;
    gap: 8px;
  ...
  .blank-embed-html-title-icon img,
  .blank-embed-html-title-icon object,
  .blank-embed-html-title-icon svg {
    width: 20px;
    height: 20px;
    fill: var(--blank-background-primary-color);
  }

  .blank-embed-html-title-text {
    display: -webkit-box;
    -webkit-line-clamp: 1;
