    ...
    <>
      ...
      >
        ...
        <div className={styles.propertyTypeName}>
          ...
          {t[`com.blank.page-properties.property.${propertyType}`]()}
        </div>
      </div>
      <MenuSeparator />
      <MenuItem
        ...
        disabled={readonly}
      >
        {t['com.blank.page-properties.property.always-show']()}
      </MenuItem>
      <MenuItem
        ...
        disabled={readonly}
      >
        {t['com.blank.page-properties.property.hide-when-empty']()}
      </MenuItem>
      <MenuItem
        prefixIcon={<InvisibleIcon />}
        ...
        disabled={readonly}
      >
        {t['com.blank.page-properties.property.always-hide']()}
      </MenuItem>
      <MenuSeparator />
      <MenuItem
        ...
        onClick={() => {
          confirmModal.openConfirmModal({
            title:
              t['com.blank.settings.workspace.properties.delete-property'](),
            description: (
              <Trans
                values={{
                  name: name,
                }}
                i18nKey="com.blank.settings.workspace.properties.delete-property-desc"
              >
