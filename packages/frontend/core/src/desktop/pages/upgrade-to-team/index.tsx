...
import { PureWorkspaceCard } from '@blank/core/components/workspace-selector/workspace-card';
import { AuthService } from '@blank/core/modules/cloud';
import {
  type WorkspaceMetadata,
  WorkspacesService,
} from '@blank/core/modules/workspace';
import { buildShowcaseWorkspace } from '@blank/core/utils/first-app-data';
import { UNTITLED_WORKSPACE_NAME } from '@blank/env/constant';
import { SubscriptionPlan, SubscriptionRecurring } from '@blank/graphql';
import { type I18nString, Trans, useI18n } from '@blank/i18n';
...
const benefitList: I18nString[] = [
  'com.blank.upgrade-to-team-page.benefit.g1',
  'com.blank.upgrade-to-team-page.benefit.g2',
  'com.blank.upgrade-to-team-page.benefit.g3',
  'com.blank.upgrade-to-team-page.benefit.g4',
];
...
export const UpgradeToTeam = ({ recurring }: { recurring: string | null }) => {
  ...
  const menuTriggerText = useMemo(() => {
    ...
    return t[
      'com.blank.upgrade-to-team-page.workspace-selector.placeholder'
    ]();
  ...
  }, [isTeam, jumpToPage, openBlank, selectedWorkspace]);

  return (
    <AuthPageContainer title={t['com.blank.upgrade-to-team-page.title']()}>
      <div className={styles.root}>
        ...
        <div className={styles.upgradeButton}>
          ...
          >
            {t['com.blank.upgrade-to-team-page.upgrade-button']()}
          </Button>
        </div>
        <div className={styles.contentContainer}>
          <div>{t['com.blank.upgrade-to-team-page.benefit.title']()}</div>
          <ul>
          ...
          <div>
            {t['com.blank.upgrade-to-team-page.benefit.description']()}
          </div>
          {selectedWorkspace && (
            <UpgradeDialog
              recurring={recurring}
  ...
  return (
    <Modal width={480} open={open} onOpenChange={onOpenChange}>
      <div className={styles.dialogTitle}>
        {t['com.blank.upgrade-to-team-page.upgrade-confirm.title']()}
      </div>
      <div className={styles.dialogMessage}>
        <Trans
          i18nKey="com.blank.upgrade-to-team-page.upgrade-confirm.description"
          components={{
    ...
    <div>
      {cloudWorkspaces.length > 0 ? (
        ...
        <div className={styles.noWorkspaceItem}>
          {t['com.blank.upgrade-to-team-page.no-workspace-available']()}
        </div>
      )}
      ...
      >
        <div className={styles.itemContent}>
          {t[
            'com.blank.upgrade-to-team-page.workspace-selector.create-workspace'
          ]()}
        </div>
      </MenuItem>
    </div>
...
const CreateWorkspaceDialog = ({
  ...
  return (
    <Modal width={480} open={open} onOpenChange={onOpenChange}>
      <div className={styles.dialogTitle}>
        {t[
          'com.blank.upgrade-to-team-page.create-and-upgrade-confirm.title'
        ]()}
      </div>
      ...
      <div className={styles.createConfirmContent}>
        <div>
          {t[
            'com.blank.upgrade-to-team-page.create-and-upgrade-confirm.description'
          ]()}
        </div>
        <Input
          placeholder={t[
            'com.blank.upgrade-to-team-page.create-and-upgrade-confirm.placeholder'
          ]()}
          value={name}
          onChange={setName}
        />
      ...
      <div className={styles.dialogFooter}>
        ...
        >
          {t[
            'com.blank.upgrade-to-team-page.create-and-upgrade-confirm.confirm'
          ]()}
        </Button>
      </div>
    </Modal>
