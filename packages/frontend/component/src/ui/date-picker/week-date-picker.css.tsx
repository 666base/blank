...
export const dayCell = style({
  ...
  selectors: {
    ...
    '&::before': {
      boxShadow: '0 0 0 2px var(--blank-brand-color)',
    },
    '&::after': {
      border: '1px solid var(--blank-brand-color)',
    },
...
export const dayCellWeek = style({
  ...
  whiteSpace: 'nowrap',
  overflow: 'hidden',
  color: 'var(--cell-color, var(--blank-text-secondary-color))',
});
export const dayCellDate = style({
  ...
  color: 'var(--cell-color, var(--blank-text-primary-color))',
});
