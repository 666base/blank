import { getNotesFromDoc } from '@blocksuite/blank-block-embed';
...
import { EMBED_CARD_HEIGHT } from '@blocksuite/blank-shared/consts';
...
async function renderNoteContent(
  ...
  noteBlocksContainer.classList.add('blank-embed-doc-content-note-blocks');
