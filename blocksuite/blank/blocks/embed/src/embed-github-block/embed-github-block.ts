import { LoadingIcon, OpenIcon } from '@blocksuite/blank-components/icons';
import type {
  EmbedGithubModel,
  EmbedGithubStyles,
} from '@blocksuite/blank-model';
import { ImageProxyService } from '@blocksuite/blank-shared/adapters';
  ...
  override renderBlock() {
    ...
    return this.renderEmbed(
      () => html`
        ...
        >
          <div class="blank-embed-github-content">
            <div class="blank-embed-github-content-title">
              <div class="blank-embed-github-content-title-icons">
                <div class="blank-embed-github-content-title-site-icon">
                  ${titleIcon}
                </div>
                ...
                ${status && statusText
                  ? html`<div
                      class=${classMap({
                        'blank-embed-github-content-title-status-icon': true,
                        [githubType]: true,
                        [status]: true,
              ...
              <div class="blank-embed-github-content-title-text">
                ${titleText}
              </div>
            </div>

            <div class="blank-embed-github-content-description">
              ${descriptionText}
            </div>

            ${githubType === 'issue' && assignees
              ? html`
                  <div class="blank-embed-github-content-assignees">
                    <div
                      class="blank-embed-github-content-assignees-text label"
                    >
                      Assignees
                    </div>

                    <div
                      class="blank-embed-github-content-assignees-text users"
                    >
                      ${assignees.length === 0
                        ? html`<span
                            class="blank-embed-github-content-assignees-text-users placeholder"
                            >No one</span
                          >`
                        : repeat(
                            assignees,
                            ...
                            (assignee, index) =>
                              html`<span
                                  class="blank-embed-github-content-assignees-text-users user"
                                  @click=${() =>
            ...
            <div class="blank-embed-github-content-url" @click=${this.open}>
              <span class="blank-embed-github-content-repo"
                >${`${owner}/${repo} |`}</span
              >

              ${createdAt
                ? html`<span class="blank-embed-github-content-date"
                    >${dateText} |</span
                  >`
                : nothing}
              <span>github.com</span>

              <div class="blank-embed-github-content-url-icon">
                ${OpenIcon}
              </div>
            </div>
          </div>
          <div class="blank-embed-github-banner">${bannerImage}</div>
        </div>
      `
    );
  }
