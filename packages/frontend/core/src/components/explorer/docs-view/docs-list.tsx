...
import { EmptyDocs } from '../../blank/empty';
...
export const DocsExplorer = ({
  ...
  const handleMultiDelete = useCallback(() => {
    ...
    openConfirmModal({
      title: t['com.blank.moveToTrash.confirmModal.title.multiple']({
        number: selectedDocIds.length.toString(),
      }),
      description: t[
        'com.blank.moveToTrash.confirmModal.description.multiple'
      ]({
        number: selectedDocIds.length.toString(),
      }),
    ...
    <>
      ...
      {!disableMultiSelectToolbar || onRestore ? (
        <ListFloatingToolbar
          ...
          content={
            <Trans
              i18nKey="com.blank.page.toolbar.selected"
