    ...
    const timeUnitProcessor = {
      second: () => {
        ...
        if (Math.abs(diffSecond) < 1) {
          return i18n['com.blank.time.now']();
        }
        if (
      ...
      day: () => {
        ...
        if (Math.abs(diffDay) < 1) {
          return i18n['com.blank.time.today']();
        }
        if (
      ...
      week: () => {
        ...
        if (Math.abs(diffWeek) < 1) {
          return i18n['com.blank.time.this-week']();
        }
        if (
      ...
      month: () => {
        ...
        if (Math.abs(diffMonth) < 1) {
          return i18n['com.blank.time.this-mouth']();
        }
        if (
      ...
      year: () => {
        ...
        if (Math.abs(diffYear) < 1) {
          return i18n['com.blank.time.this-year']();
        }
        if (
