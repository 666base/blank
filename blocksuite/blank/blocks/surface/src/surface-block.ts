import type { Color } from '@blocksuite/blank-model';
import {
  FeatureFlagService,
  ThemeProvider,
...
export class SurfaceBlockComponent extends BlockComponent<SurfaceBlockModel> {
  ...
  override render() {
    return html`
      <div class="blank-edgeless-surface-block-container">
        <!-- attach canvas later in renderer -->
      </div>
    `;
  }

  @query('.blank-edgeless-surface-block-container')
  private accessor _surfaceContainer!: HTMLElement;
}

declare global {
  interface HTMLElementTagNameMap {
    'blank-surface': SurfaceBlockComponent;
  }
}
