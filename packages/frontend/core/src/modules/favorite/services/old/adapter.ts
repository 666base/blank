...
import { createYProxy } from '@blocksuite/blank/store';
...
import {
  ...
  type WorkspaceBlankProperties,
} from './schema';

const BLANK_PROPERTIES_ID = 'blank:workspace-properties';
...
class WorkspacePropertiesAdapter {
  ...
  public readonly proxy: WorkspaceBlankProperties;
  public readonly properties: Y.Map<any>;
  public readonly properties$: LiveData<WorkspaceBlankProperties>;
  ...
  constructor(public readonly workspaceService: WorkspaceService) {
    ...
    this.properties = rootDoc.getMap(BLANK_PROPERTIES_ID);
