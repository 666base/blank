...
pdfMake.fonts = {
  Inter: {
    normal: 'https://cdn.blank.pro/fonts/Inter-Regular.woff',
    bold: 'https://cdn.blank.pro/fonts/Inter-SemiBold.woff',
    italics: 'https://cdn.blank.pro/fonts/Inter-Italic.woff',
    bolditalics: 'https://cdn.blank.pro/fonts/Inter-SemiBoldItalic.woff',
  },
  SarasaGothicCL: {
    normal: 'https://cdn.blank.pro/fonts/SarasaGothicCL-Regular.ttf',
    bold: 'https://cdn.blank.pro/fonts/SarasaGothicCL-Regular.ttf',
    italics: 'https://cdn.blank.pro/fonts/SarasaGothicCL-Regular.ttf',
    bolditalics: 'https://cdn.blank.pro/fonts/SarasaGothicCL-Regular.ttf',
  },
};
...
export class PdfAdapter extends BaseAdapter<PdfAdapterFile> {
  ...
  private async _blockToContent(
    ...
    if (flavour === 'blank:paragraph') {
      ...
      return content;
    } else if (flavour === 'blank:bookmark') {
      content.push({
    ...
    if (block.children && block.children.length) {
      const shouldIncrementDepth =
        flavour !== 'blank:page' && flavour !== 'blank:note';
  ...
  private async _createListContent(
    ...
    const blueColor = resolveCssVariable('var(--blank-blue-700)') || '#1E96EB';
  ...
  private async _createCalloutContent(
    ...
    const colorVar =
      backgroundColorName === 'default' || backgroundColorName === 'grey'
        ? 'var(--blank-v2-block-callout-background-grey)'
        : `var(--blank-v2-block-callout-background-${backgroundColorName})`;
