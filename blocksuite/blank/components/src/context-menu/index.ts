...
export function effects() {
  customElements.define('blank-menu', MenuComponent);
  customElements.define('mobile-menu', MobileMenuComponent);
  customElements.define('blank-menu-button', MenuButton);
  customElements.define('mobile-menu-button', MobileMenuButton);
  customElements.define('blank-menu-input', MenuInput);
  customElements.define('mobile-menu-input', MobileMenuInput);
  customElements.define('blank-menu-sub-menu', MenuSubMenu);
