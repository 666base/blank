...
describe('framework', () => {
  ...
  test('scope', () => {
    ...
    expect(root.get(SystemService).appName).toEqual('blank');
    ...
    expect(workspaceService.system.appName).toEqual('blank');
    ...
    expect(pageService.system.appName).toEqual('blank');
