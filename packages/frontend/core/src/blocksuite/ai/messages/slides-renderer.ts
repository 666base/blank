...
import { BlockStdScope, type EditorHost } from '@blocksuite/blank/std';
...
export const createSlidesRenderer: (
  host: EditorHost,
  ctx: AIContext
) => BlankAIPanelWidgetConfig['answerRenderer'] = (host, ctx) => {
  return (answer, state) => {
    if (state === 'generating') {
...
export class AISlidesRenderer extends WithDisposable(LitElement) {
  ...
  protected override render() {
    return html`<style>
        ...
        .edgeless-container blank-edgeless-zoom-toolbar-widget,
        edgeless-toolbar {
          display: none;
        }
        ...
        * {
        ...
        .blank-edgeless-surface-block-container {
          position: absolute;
          width: 100%;
          height: 100%;
        }

        .blank-edgeless-surface-block-container canvas {
          width: 100%;
          height: 100%;
          position: relative;
          z-index: 1;
        ...
        .blank-block-children-container.edgeless {
          padding-left: 0;
          position: relative;
          overflow: hidden;
          height: 100%;
        ...
        .blank-edgeless-block-child {
          position: absolute;
          transform-origin: center;
          box-sizing: border-box;
          border: 2px solid var(--blank-white-10);
          border-radius: 8px;
          box-shadow: var(--blank-shadow-3);
          pointer-events: all;
        }

        blank-edgeless-image .resizable-img,
        blank-edgeless-image .resizable-img img {
          width: 100%;
          height: 100%;
        }

        .blank-edgeless-layer {
          position: absolute;
          top: 0;
          left: 0;
      ...
      <div class="slides-container">
        <div
          class="edgeless-container blank-edgeless-viewport"
