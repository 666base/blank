...
} from '@blocksuite/blank-block-database';
import {
...
import type { HighlightType } from '@blocksuite/blank-components/highlight-dropdown-menu';
import { toast } from '@blocksuite/blank-components/toast';
import { EditorChevronDown } from '@blocksuite/blank-components/toolbar';
...
import { getMostCommonValue } from '@blocksuite/blank-shared/utils';
      ...
      content: html`
        ...
        >
          <div data-size="large" data-orientation="vertical">
            ${repeat(
              textConversionConfigs.filter(c => c.flavour !== 'blank:divider'),
              item => item.name,
