...
export class ImagePreviewGrid extends LitElement {
  static override styles = css`
    ...
    .image-container {
      ...
      align-items: center;
      flex: 0 0 auto;
      border: 1px solid var(--blank-v2-layer-insideBorder-border);
    ...
    .close-wrapper {
      ...
      height: 16px;
      border-radius: 4px;
      border: 0.5px solid var(--blank-v2-layer-insideBorder-border);
      justify-content: center;
      align-items: center;
      display: none;
      position: absolute;
      background-color: var(--blank-v2-layer-background-primary);
    ...
    .close-wrapper:hover {
      background-color: var(--blank-v2-layer-background-error);
      border: 0.5px solid var(--blank-v2-button-error);
      color: var(--blank-v2-button-error);
    }
  `;
