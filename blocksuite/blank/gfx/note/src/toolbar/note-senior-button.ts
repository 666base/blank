...
export class EdgelessNoteSeniorButton extends EdgelessToolbarToolMixin(
  ...
  static override styles = css`
    ...
    .note-root[data-app-theme='light'] {
      --paper-border-color: var(--blank-pure-white);
    ...
    .note-root[data-app-theme='dark'] {
      --paper-border-color: var(--blank-divider-color);
  ...
  override render() {
    ...
    return html`<edgeless-toolbar-button
      ...
      .tooltip=${this.popper
        ? ''
        : html`<blank-tooltip-content-with-shortcut
            data-tip="${'Note'}"
            data-shortcut="${'N'}"
  ...
  @state()
  accessor childFlavour: NoteToolOption['childFlavour'] = 'blank:paragraph';
