...
// In Blank, to avoid the option element to be covered by the header, we need to reserve the space for the header
...
export const DEFAULT_IMAGE_PROXY_ENDPOINT =
  'https://blank-worker.toeverything.workers.dev/api/worker/image-proxy';

// https://github.com/666base/blank-workers/tree/main/packages/link-preview
export const DEFAULT_LINK_PREVIEW_ENDPOINT =
  'https://blank-worker.toeverything.workers.dev/api/worker/link-preview';
...
export const CANVAS_EXPORT_IGNORE_TAGS = [
  ...
  'BLANK-DRAG-HANDLE-WIDGET',
  'BLANK-TOOLBAR-WIDGET',
  'BLANK-BLOCK-SELECTION',
];
