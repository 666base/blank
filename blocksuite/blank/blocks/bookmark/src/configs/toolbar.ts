...
import { reassociateConnectorsCommand } from '@blocksuite/blank-block-surface';
...
import { getBlockProps } from '@blocksuite/blank-shared/utils';
...
const previewAction = {
  ...
  content(ctx) {
    ...
    return html`<blank-link-preview .url=${url}></blank-link-preview>`;
  },
  ...
  actions: [
      ...
      actions: [
        {
          ...
          run(ctx) {
            ...
            ctx.store.addBlock('blank:paragraph', { text }, parent, index);
    ...
    } satisfies ToolbarActionGroup<ToolbarAction>,
    {
      ...
      content(ctx) {
        ...
        return html`${keyed(
          model,
          html`<blank-card-style-dropdown-menu
            @toggle=${onToggle}
            .actions=${actions}
            .context=${ctx}
  ...
  actions: [
    ...
    },
    {
      ...
      content(ctx) {
        ...
        return html`${keyed(
          model,
          html`<blank-size-dropdown-menu
            @select=${onSelect}
            @toggle=${onToggle}
            .format=${format}
            .sizeSignal=${scale$}
          ></blank-size-dropdown-menu>`
        )}`;
      },
    },
  ],
...
export const createBuiltinToolbarConfigExtension = (
  ...
  return [
    ...
    ToolbarModuleExtension({
      id: BlockFlavourIdentifier(`blank:surface:${name}`),
