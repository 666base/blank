import { DropdownButton, Menu } from '@blank/component';
import { BlockCard } from '@blank/component/card/block-card';
...
export const CreateNewPagePopup = ({
  ...
  return (
    ...
    >
      <BlockCard
        title={t['com.blank.new.page-mode']()}
        desc={t['com.blank.write_with_a_blank_page']()}
      ...
      />
      <BlockCard
        title={t['com.blank.new_edgeless']()}
        desc={t['com.blank.draw_with_a_blank_whiteboard']()}
      ...
      {importFile ? (
        <BlockCard
          title={t['com.blank.new_import']()}
          desc={t['com.blank.import_file']()}
