  ...
  return (
    <>
      <Input
        ...
        placeholder={t['com.blank.auth.set.password.placeholder']({
        ...
        endFix={
          <div className={statusWrapper}>
            {status ? (
              <Tag
                status={status}
                minimum={t['com.blank.auth.set.password.message.minlength']({
                  min: String(passwordLimits.minLength),
                })}
                maximum={t['com.blank.auth.set.password.message.maxlength']({
      ...
      <Input
        ...
        type="password"
        size="extraLarge"
        placeholder={t['com.blank.auth.set.password.placeholder.confirm']()}
