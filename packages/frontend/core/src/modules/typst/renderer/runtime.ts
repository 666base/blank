...
export const DEFAULT_TYPST_FONT_URLS = [
  'https://cdn.blank.pro/fonts/Inter-Regular.woff',
  'https://cdn.blank.pro/fonts/Inter-SemiBold.woff',
  'https://cdn.blank.pro/fonts/Inter-Italic.woff',
  'https://cdn.blank.pro/fonts/Inter-SemiBoldItalic.woff',
  'https://cdn.blank.pro/fonts/SarasaGothicCL-Regular.ttf',
] as const;
