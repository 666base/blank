...
export class ParagraphHeadingIcon extends SignalWatcher(
  ...
  static override styles = css`
    blank-paragraph-heading-icon .heading-icon {
      display: flex;
      align-items: start;
      margin-top: 0.3em;
      position: absolute;
...
export function effects() {
  customElements.define('blank-paragraph-heading-icon', ParagraphHeadingIcon);
}

declare global {
  interface HTMLElementTagNameMap {
    'blank-paragraph-heading-icon': ParagraphHeadingIcon;
  }
}
