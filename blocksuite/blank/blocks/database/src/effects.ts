...
export function effects() {
  customElements.define('blank-database-title', DatabaseTitle);
  customElements.define('data-view-header-area-icon', IconCell);
  customElements.define('blank-database-link-cell', LinkCell);
  customElements.define('data-view-header-area-text', HeaderAreaTextCell);
  customElements.define('blank-database-rich-text-cell', RichTextCell);
  customElements.define('blank-database-created-time-cell', CreatedTimeCell);
  ...
  customElements.define('blank-database', DatabaseBlockComponent);

  customElements.define(
    'blank-dnd-preview-database',
