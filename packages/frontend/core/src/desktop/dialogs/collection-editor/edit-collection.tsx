import { Button, RadioGroup } from '@blank/component';
import { SelectPage } from '@blank/core/components/page-list/docs/select-page';
    ...
    () => (
      <>
        <Button onClick={onCancel} className={styles.actionButton}>
          {t['com.blank.editCollection.button.cancel']()}
        </Button>
        <Button
        ...
        >
          {onConfirmText ?? t['com.blank.editCollection.button.create']()}
        </Button>
      </>
    ),
    ...
    () => (
      <RadioGroup
        ...
        items={[
          {
            value: 'page',
            label: t['com.blank.editCollection.pages'](),
            testId: 'edit-collection-pages-button',
          },
          {
            value: 'rule',
            label: t['com.blank.editCollection.rules'](),
