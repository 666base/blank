...
import { MAX_IMAGE_WIDTH } from '@blocksuite/blank-model';
import { TelemetryProvider } from '@blocksuite/blank-shared/services';
import type { NoteChildrenFlavour } from '@blocksuite/blank-shared/types';
import {
  getImageFilesFromLocal,
  openSingleFileWith,
} from '@blocksuite/blank-shared/utils';
import { EdgelessToolbarToolMixin } from '@blocksuite/blank-widget-edgeless-toolbar';
      ...
      <edgeless-slide-menu>
        <div class="menu-content">
          ...
          <div class="button-group-container">
            ...
            <edgeless-tool-icon-button
              .activeMode=${'background'}
              .tooltip=${html`<blank-tooltip-content-with-shortcut
                data-tip="${'Link'}"
                data-shortcut="${'@'}"
              ></blank-tooltip-content-with-shortcut>`}
              @click=${() => {
