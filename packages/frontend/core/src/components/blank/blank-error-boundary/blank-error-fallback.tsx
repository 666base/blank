...
import * as styles from './blank-error-fallback.css';
...
export interface BlankErrorFallbackProps extends FallbackProps {
  height?: number | string;
  className?: string;
}

export const BlankErrorFallback: FC<BlankErrorFallbackProps> = props => {
...
export const BlankErrorComponent = () => {
  ...
  return (
    <ErrorDetail
      title={t['com.blank.error.unexpected-error.title']()}
      resetError={reloadPage}
      buttonText={t['com.blank.error.reload']()}
      description={
