...
export class BlankCodeUnit extends ShadowlessElement {
  get codeBlock() {
    return this.closest('blank-code');
  }
  ...
  override render() {
    ...
    let style = this.delta.attributes
      ? blankTextStyles(this.delta.attributes)
      : {};
