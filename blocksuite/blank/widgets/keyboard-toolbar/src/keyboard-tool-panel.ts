...
export const BLANK_KEYBOARD_TOOL_PANEL = 'blank-keyboard-tool-panel';

@requiredProperties({
  context: PropTypes.object,
})
export class BlankKeyboardToolPanel extends SignalWatcher(
  ...
  override render() {
    ...
    return html`<div class="blank-keyboard-tool-panel-container">
      ${repeat(
        groups,
        group => group.name,
