...
import { TemplateListMenu } from '@blank/core/modules/template-doc/view/template-list-menu';
...
export const TemplateDocSetting = () => {
  ...
  return (
    <SettingWrapper title={t['com.blank.settings.workspace.template.title']()}>
      <SettingRow
        name={t['com.blank.settings.workspace.template.journal']()}
        desc={t['com.blank.settings.workspace.template.journal-desc']()}
      >
        <TemplateSelector
      ...
      <SettingRow
        name={t['com.blank.settings.workspace.template.page']()}
        desc={t['com.blank.settings.workspace.template.page-desc']()}
      >
        <Switch
      ...
      {enablePageTemplate ? (
        <SettingRow
          name={t['com.blank.settings.workspace.template.page-select']()}
          desc={null}
        >
          <TemplateSelector
    ...
    <TemplateListMenu
      ...
      suffixItems={
        <>
          ...
          >
            {t['com.blank.settings.workspace.template.remove']()}
          </MenuItem>
        </>
      }
    >
      <MenuTrigger className={styles.menuTrigger} data-testid={testId}>
        ...
        {title ?? t['com.blank.settings.workspace.template.keep-empty']()}
      </MenuTrigger>
    </TemplateListMenu>
  );
};
