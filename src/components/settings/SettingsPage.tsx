...
type SettingsTab = "general" | "tools" | "editor" | "shortcuts" | "about" | "cloud";
...
const tabs: {
  ...
  { id: "cloud", label: "Cloud Sync", icon: IntegrationsIcon, shortcut: "5" },
      ...
      <div className="flex-1 flex flex-col bg-bg overflow-hidden">
        ...
        >
          <div className="w-full max-w-3xl mx-auto px-6 pb-6">
            ...
            { activeTab === "cloud" && <CloudSyncSettingsSection /> }
