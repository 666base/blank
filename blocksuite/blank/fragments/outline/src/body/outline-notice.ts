...
export const BLANK_OUTLINE_NOTICE = 'blank-outline-notice';
...
export class OutlineNotice extends SignalWatcher(
  ...
  override render() {
    ...
    return html`
      <div data-testid=${BLANK_OUTLINE_NOTICE} class=${styles.outlineNotice}>
...
declare global {
  interface HTMLElementTagNameMap {
    [BLANK_OUTLINE_NOTICE]: OutlineNotice;
  }
}
