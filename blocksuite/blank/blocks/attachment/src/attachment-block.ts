import {
  ...
  SelectedStyle,
} from '@blocksuite/blank-components/caption';
import {
...
import {
  ...
  ResourceController,
} from '@blocksuite/blank-components/resource';
...
export class AttachmentBlockComponent extends CaptionedBlockComponent<AttachmentBlockModel> {
  ...
  protected renderUpgradeButton = () => {
    ...
    return when(
      ...
      () => html`
        <button
          class="blank-attachment-content-button"
  ...
  protected renderWithHorizontal(
    ...
    return html`
      <div class=${classMap(classInfo)}>
        <div class="blank-attachment-content">
          <div class="blank-attachment-content-title">
            <div class="blank-attachment-content-title-icon">${icon}</div>
            <div class="blank-attachment-content-title-text truncate">
              ${title}
            </div>
          </div>

          <div class="blank-attachment-content-description">
            <div class="blank-attachment-content-info truncate">
              ${description}
            </div>
            ${choose(state, [
        ...
        <div class="blank-attachment-banner">${kind}</div>
      </div>
    `;
  }
  ...
  protected renderWithVertical(
    ...
    return html`
      <div class=${classMap(classInfo)}>
        ...
        <div class="blank-attachment-banner">
          ${kind}
          ${choose(state, [
            ['error', () => this.renderNormalButton(needUpload)],
            ['error:oversize', this.renderUpgradeButton],
  ...
  protected renderEmbedView = () => {
    ...
    return html`
      <div class="blank-attachment-embed-container">
      ...
      ${when(enabled, () => {
        ...
        return html`
          <blank-resource-status
            class="blank-attachment-embed-status"
            .message=${message}
  ...
  private readonly _renderCitation = () => {
    ...
    return html`<blank-citation-card
      .icon=${icon}
      .citationTitle=${name}
  ...
  override renderBlock() {
    return html`
      <div
        class=${classMap({
          'blank-attachment-container': true,
...
declare global {
  interface HTMLElementTagNameMap {
    'blank-attachment': AttachmentBlockComponent;
  }
}
