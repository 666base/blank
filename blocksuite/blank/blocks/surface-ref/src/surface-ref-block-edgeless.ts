import { type SurfaceRefBlockModel } from '@blocksuite/blank-model';
...
export class EdgelessSurfaceRefBlockComponent extends BlockComponent<SurfaceRefBlockModel> {
  static override styles = css`
    blank-edgeless-surface-ref {
      position: relative;
      overflow: hidden;
    }

    .blank-edgeless-surface-ref-container {
      border-radius: 8px;
      border: 1px solid
    ...
    .blank-edgeless-surface-ref-container.focused {
  ...
  override renderBlock() {
    return html` <div
      class=${classMap({
        'blank-edgeless-surface-ref-container': true,
...
declare global {
  interface HTMLElementTagNameMap {
    'blank-edgeless-surface-ref': EdgelessSurfaceRefBlockComponent;
  }
}
