...
export const MemberLimitModal = ({
  ...
  return (
    <ConfirmModal
      ...
      title={t['com.blank.payment.member-limit.title']()}
      description={
        <ConfirmDescription plan={plan} quota={quota} isFreePlan={isFreePlan} />
      }
      confirmText={t['com.blank.payment.upgrade']()}
...
export const ConfirmDescription = ({
  ...
  return (
    <div>
      {t['com.blank.payment.member-limit.description']({
        planName: plan,
        quota: quota,
      })}
      <ul className={styles.ulStyle}>
        {isFreePlan && (
          <li className={styles.liStyle}>
            ...
            {t[
              'com.blank.payment.member-limit.description.tips-for-free-plan'
            ]()}
          </li>
        )}
        <li className={styles.liStyle}>
          <div className={styles.prefixDot} />
          {t['com.blank.payment.member-limit.description.tips-1']()}
        </li>
        <li className={styles.liStyle}>
          <div className={styles.prefixDot} />
          {t['com.blank.payment.member-limit.description.tips-2']()}
        </li>
      </ul>
    </div>
  );
