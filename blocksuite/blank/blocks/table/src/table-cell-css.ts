import { cssVar, cssVarV2 } from '@blocksuite/blank-shared/theme';
...
export const cellContainerStyle = css({
  ...
  textAlign: 'start',
  verticalAlign: 'top',
  'blank-table[data-internal-range-selection="true"] &': {
    userSelect: 'text',
    WebkitUserSelect: 'text',
  },
  'blank-table[data-internal-range-selection="true"] & rich-text': {
    userSelect: 'text',
    WebkitUserSelect: 'text',
  },
  'blank-table[data-internal-range-selection="true"] & rich-text *': {
