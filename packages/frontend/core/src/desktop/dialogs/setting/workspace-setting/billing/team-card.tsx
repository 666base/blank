...
import { SubscriptionRecurring } from '@blank/graphql';
...
export const TeamCard = () => {
  ...
  const description = useMemo(() => {
    if (recurring === SubscriptionRecurring.Yearly) {
      return t[
        'com.blank.settings.workspace.billing.team-workspace.description.billed.annually'
      ]();
    }
    if (recurring === SubscriptionRecurring.Monthly) {
      return t[
        'com.blank.settings.workspace.billing.team-workspace.description.billed.monthly'
      ]();
    }
    return t['com.blank.payment.billing-setting.free-trial']();
  }, [recurring, t]);

  const expirationDate = useMemo(() => {
    if (expiration && endDate) {
      return t[
        'com.blank.settings.workspace.billing.team-workspace.not-renewed'
      ]({
    ...
    if (nextBillingDate && endDate) {
      return t[
        'com.blank.settings.workspace.billing.team-workspace.next-billing-date'
      ]({
        date: new Date(endDate).toLocaleDateString(),
      });
    }
      ...
      <div className={styles.currentPlan}>
        <SettingRow
          ...
          name={
            <CardNameLabelRow
              cardName={t[
                'com.blank.settings.workspace.billing.team-workspace'
              ]()}
        ...
        >
          ...
          >
            {t[
              'com.blank.settings.workspace.billing.team-workspace.cancel-plan'
            ]()}
          </Button>
        </CancelTeamAction>
      </div>
