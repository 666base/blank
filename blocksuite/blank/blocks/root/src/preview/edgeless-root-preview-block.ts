...
import { requestThrottledConnectedFrame } from '@blocksuite/blank-shared/utils';
import {
  BlockComponent,
...
export class EdgelessRootPreviewBlockComponent extends BlockComponent<RootBlockModel> {
  static override styles = css`
    ...
    blank-edgeless-root-preview .widgets-container {
      position: absolute;
      left: 0;
      top: 0;
      contain: size layout;
    ...
    blank-edgeless-root-preview .edgeless-background {
      height: 100%;
