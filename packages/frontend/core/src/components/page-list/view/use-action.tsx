    ...
    return [
      {
        icon: <FilterIcon />,
        name: 'edit',
        tooltip: t['com.blank.collection-bar.action.tooltip.edit'](),
        click: () => {
          openEdit(collection);
        },
      },
      {
        icon: <DeleteIcon style={{ color: 'var(--blank-error-color)' }} />,
        name: 'delete',
        tooltip: t['com.blank.collection-bar.action.tooltip.delete'](),
        click: onDelete,
      },
    ];
